...
// Native classes
init.mangledNames = {get$effect: "effect", get$value: "value"};
init.mangledGlobalNames = {MaskIcon_CODE: "CODE", MaskIcon_ERROR: "ERROR", MaskIcon_INFO: "INFO", MaskIcon_LOADING: "LOADING", MaskIcon_QUESTION: "QUESTION", MaskIcon_WARN: "WARN", MaskMode_NOBTT: "NOBTT", MaskMode_OK: "OK", MaskMode_OKCANCEL: "OKCANCEL", MaskMode_YESNO: "YESNO"};
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasRenderingContext|CanvasRenderingContext2D|MediaError|MediaKeyError|Navigator|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["all_tests", "all_tests.dart", , X, {
  "^": "",
  run: function() {
    N.group("create objects", new X.run_closure());
    N.group("initialization", new X.run_closure0());
  },
  main: [function() {
    N.Logger_Logger("").set$level(C.Level_ALL_0);
    N.Logger_Logger("").get$onRecord().listen$1(new X.main_closure());
    N.group("run", new X.main_closure0());
  }, "call$0", "main$closure", 0, 0, 10],
  run_closure: {
    "^": "Closure:10;",
    call$0: function() {
      A.ItinnUtilContext_instance().mask = new X.TestMask(null);
    },
    $isFunction: true
  },
  run_closure0: {
    "^": "Closure:10;",
    call$0: function() {
      N.test("first init", new X.run__closure());
      N.test("clear init", new X.run__closure0());
      N.test("server init", new X.run__closure1());
    },
    $isFunction: true
  },
  run__closure: {
    ...
    call$0: [function() {
      var ctx, f;
      ctx = A.ItinnUtilContext_instance();
      f = ctx.init$0().then$1(new X.run___closure3(ctx));
      Y.expect(f, new Z._Completes(Y.wrapMatcher(true), ""), null, null, false);
      return f;
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  run___closure3: {
    ...
    call$1: [function(ok) {
      var t1 = this.ctx_0;
      Y.expect(t1.storage, C.C__IsNotNull, null, null, false);
      Y.expect(t1.server, C.C__IsNotNull, null, null, false);
      return ok;
  ...
  run__closure0: {
    ...
    call$0: [function() {
      var ctx, f;
      ctx = A.ItinnUtilContext_instance();
      f = ctx.storage.clearAll$1$deep(true).then$1(new X.run___closure2(ctx));
      Y.expect(f, new Z._Completes(Y.wrapMatcher(true), ""), null, null, false);
      return f;
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  ...
  run___closure2: {
    ...
    call$1: [function(_) {
      var t1 = this.ctx_1;
      return t1.init$0().then$1(new X.run____closure0(t1));
  ...
  run__closure1: {
    ...
    call$0: [function() {
      var ctx, f;
      ctx = A.ItinnUtilContext_instance();
      f = ctx.storage.settAction$1(new X.run___closure()).then$1(new X.run___closure0(ctx));
      Y.expect(f, new Z._Completes(Y.wrapMatcher(true), ""), null, null, false);
      P.Timer_Timer(P.Duration$(0, 0, 0, 1000, 0, 0), new X.run___closure1(ctx));
      return f;
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  run___closure: {
    "^": "Closure:55;",
    call$1: function(sett) {
      sett.set$me(new K.UserDO(null, null, null, null, null, null, null, null, null, null));
      sett.set$token("BOTEBUICPT");
      sett.set$offline(false);
    },
    $isFunction: true
  },
  run___closure0: {
    ...
    call$1: [function(_) {
      var t1 = this.ctx_3;
      return t1.init$0().then$1(new X.run____closure(t1));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  run____closure: {
  ...
  run___closure1: {
    "^": "Closure:10;ctx_5",
    call$0: [function() {
      var mask = this.ctx_5.mask;
      if (!!J.getInterceptor(mask).$isTestMask && mask.c != null)
        mask._all_tests$_complete$1($.get$MaskComplete_OK());
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  main_closure: {
    "^": "Closure:61;",
    call$1: [function(rec) {
      P.print(rec.get$level().name + ": " + rec.get$loggerName() + ": " + rec.get$time().toString$0(0) + ": " + H.S(J.get$message$x(rec)));
  ...
  TestMask: {
    "^": "Mask;c",
    _getNewFuture$0: function() {
      var t1, t2;
      t1 = this.c;
      if (t1 != null) {
        t2 = $.get$MaskComplete_UNKNOWN();
        t1 = t1.future;
        if (t1._state !== 0)
    ...
    _all_tests$_complete$1: function(completeStatus) {
      var t1, ret;
      t1 = this.c;
      if (t1 != null) {
        t1 = t1.future;
        if (t1._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t1._asyncComplete$1(completeStatus);
        ret = this.c.future;
        this.c = null;
        return ret;
      } else
        return P._Future$immediate(completeStatus, null);
    },
    $isTestMask: true
  }
},
...
["dart.async", "dart:async", , P, {
  ...
  }, "call$6", "_rootRunBinary$closure", 12, 0, 27, 20, 21, 22, 24, 6, 7],
  ...
  }, "call$4", "_rootScheduleMicrotask$closure", 8, 0, 31],
  _rootCreateTimer: [function($self, $parent, zone, duration, callback) {
    return P._createTimer(duration, C.C__RootZone !== zone ? zone.bindCallback$1(callback) : callback);
  }, "call$5", "_rootCreateTimer$closure", 10, 0, 32],
  _rootPrint: [function($self, $parent, zone, line) {
    H.printString(line);
  }, "call$4", "_rootPrint$closure", 8, 0, 33],
  _printToZone: [function(line) {
    J.print$1$x($.Zone__current, line);
  }, "call$1", "_printToZone$closure", 2, 0, 34],
  ...
  }, "call$5", "_rootFork$closure", 10, 0, 35],
  ...
  _AsBroadcastStreamController: {
    ...
    }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 63, 16, 17, 18],
    close$0: [function(_) {
      var t1 = this._state;
      if ((t1 & 4) === 0 && (t1 & 2) !== 0) {
  ...
  Future_wait_closure: {
    "^": "Closure:67;box_0,eagerError_2,pos_3",
  ...
  _SyncCompleter: {
    ...
    completeError$2: [function(error, stackTrace) {
      ...
      return this.completeError$2(error, null);
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 63, 16, 17, 18]
  },
  _Future: {
  ...
  _AsBroadcastStream: {
    ...
    }, "call$0", "get$_onCancel", 0, 0, 12],
    _onListen$0: [function() {
      var t1 = this._onListenHandler;
      if (t1 != null)
        this._zone.runUnary$2(t1, H.setRuntimeTypeInfo(new P._BroadcastSubscriptionWrapper(this), [null]));
    }, "call$0", "get$_onListen", 0, 0, 12],
  ...
  _cancelAndErrorClosure_closure: {
    "^": "Closure:73;subscription_0,future_1",
    call$2: function(error, stackTrace) {
  ...
  _rootFork_closure: {
    "^": "Closure:53;copiedMap_0",
    call$2: [function(key, value) {
      this.copiedMap_0.$indexSet(0, key, value);
    }, "call$2", null, 4, 0, null, 54, 14, "call"],
    $isFunction: true
  },
...
["dart.collection", "dart:collection", , P, {
  ...
  }, "call$1", "_defaultHashCode$closure", 2, 0, 37, 38],
  ...
  _HashSet: {
    "^": "_HashSetBase;_length,_strings,_nums,_rest,_elements",
    _newSet$0: function() {
...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:76;box_0,this_1,codeUnits_2",
...
["dart.core", "dart:core", , P, {
  ...
  Uri__normalize_normalizeHexDigit: {
    "^": "Closure:80;component_1,isNormalizedHexDigit_2,isLowerCaseHexDigit_3",
    call$1: function(index) {
      var t1, codeUnit;
      t1 = this.component_1;
...
["dart.dom.indexed_db", "dart:indexed_db", , P, {
  ...
  Cursor: {
    ...
    }, "next$0", "call$1", "call$0", "get$next", 0, 2, 52, 16],
    "%": ";IDBCursor"
  },
  CursorWithValue: {
    "^": "Cursor;",
  ...
  ObjectStore: {
    "^": "Interceptor;indexNames=,keyPath=,name=",
  ...
  ObjectStore__cursorStreamFromResult_closure: {
    "^": "Closure:55;request_0,autoAdvance_1,controller_2",
    call$1: [function(e) {
      var cursor, t1, t2;
...
["dart.math", "dart:math", , P, {
  ...
  max: [function(a, b) {
    ...
    if (b === 0 && C.JSNumber_methods.get$isNegative(a))
      return b;
    return a;
  }, "call$2", "max$closure", 4, 0, 46, 38, 47],
  _JSRandom: {
    "^": "Object;",
...
["date_symbol_data_local", "package:intl/date_symbol_data_local.dart", , N, {
  ...
  }, "call$0", "dateTimeSymbolMap$closure", 0, 0, 48]
}],
...
["date_time_patterns", "package:intl/date_time_patterns.dart", , N, {
  ...
  dateTimePatternMap: [function() {
    return C.Map_aOFyV;
  }, "call$0", "dateTimePatternMap$closure", 0, 0, 48]
}],
...
["html_common", "dart:html_common", , P, {
  ...
  _convertDartToNative_PrepareForStructuredClone_walk: {
    "^": "Closure:55;findSlot_5,readSlot_6,writeSlot_7",
    call$1: function(e) {
  ...
  convertNativeToDart_AcceptStructuredClone_walk: {
    "^": "Closure:55;mustCopy_4,findSlot_5,readSlot_6,writeSlot_7",
    call$1: function(e) {
...
["itinndata", "package:itinndata/itinndata.dart", , K, {
  "^": "",
  ItinnDataContext: {
    "^": "Object;LOG",
    static: {"^": "ItinnDataContext__singleton", ItinnDataContext_randomStrings: function($length) {
        var a, buffer, k, t1;
        P.LinkedHashSet_LinkedHashSet(null, null, null, P.String);
        a = C.JSString_methods.codeUnitAt$1("a", 0);
        buffer = P.StringBuffer$("");
        for (k = 0; k < $length; ++k) {
          t1 = H.Primitives_stringFromCharCode(C.C__JSRandom.nextInt$1(26) + a);
          buffer._contents += t1;
        }
        return buffer._contents;
      }}
  ...
  LocalDO: {
    ...
    toJsonMap$0: function() {
      return P.LinkedHashMap_LinkedHashMap$_literal(["id", this.Id], null, null);
    },
    toJson$0: function() {
      return C.JsonCodec_null_null.encode$1(this.toJsonMap$0());
    },
    toString$0: function(_) {
      return this.toJsonMap$0().toString$0(0);
    }
  },
  Object_Observable: {
    "^": "Object+Observable;"
  ...
  GeneralDO: {
    "^": "LocalDO;Sync@,SyncId@,Version<",
    toJsonMap$0: function() {
      return P.LinkedHashMap_LinkedHashMap$_literal(["id", this.Id, "syncId", this.SyncId, "version", this.Version, "sync", this.Sync], null, null);
    },
    toJson$0: function() {
      return C.JsonCodec_null_null.encode$1(this.toJsonMap$0());
    },
  ...
  UserDO: {
    "^": "GeneralDO;ProfileID,Name,ProfileIDs,Sync,SyncId,Version,Id,observable$Observable$_changes,observable$Observable$_values,observable$Observable$_records",
    toJsonMap$0: function() {
      var map = K.GeneralDO.prototype.toJsonMap$0.call(this);
      map.$indexSet(0, "activeProfile", this.ProfileID);
      map.$indexSet(0, "name", this.Name);
      map.$indexSet(0, "profileIds", this.ProfileIDs);
      return map;
    },
    merge$1: function(other) {
      K.GeneralDO.prototype.merge$1.call(this, other);
      this.Name = other.Name;
      this.ProfileID = other.ProfileID;
      this.ProfileIDs = other.ProfileIDs;
    },
    static: {UserDO_fromJsonMap: function(jsonMap, item) {
        var t1;
        if (jsonMap == null)
          return;
        if (item == null)
          item = new K.UserDO(null, null, null, null, null, null, null, null, null, null);
        t1 = J.getInterceptor$asx(jsonMap);
        item.Id = t1.$index(jsonMap, "id");
        item.Sync = t1.$index(jsonMap, "sync");
        item.SyncId = t1.$index(jsonMap, "syncId");
        item.Version = t1.$index(jsonMap, "version") != null ? J.floor$0$n(t1.$index(jsonMap, "version")) : 0;
        item.ProfileID = t1.$index(jsonMap, "activeProfile");
        item.Name = t1.$index(jsonMap, "name");
        item.ProfileIDs = t1.$index(jsonMap, "profileIds");
        return item;
      }}
  },
  ProfileDO: {
    "^": "LocalDO;ProfileKey,UserIDs,Roles,Id,observable$Observable$_changes,observable$Observable$_values,observable$Observable$_records",
    toJsonMap$0: function() {
      var map = K.LocalDO.prototype.toJsonMap$0.call(this);
      map.$indexSet(0, "key", this.ProfileKey);
      map.$indexSet(0, "userIds", this.UserIDs);
      map.$indexSet(0, "roles", this.Roles);
      return map;
    },
    static: {ProfileDO_fromJsonMap: function(jsonMap, item) {
        var t1;
        if (jsonMap == null)
          return;
        if (item == null)
          item = new K.ProfileDO(null, null, null, null, null, null, null);
        t1 = J.getInterceptor$asx(jsonMap);
        item.Id = t1.$index(jsonMap, "id");
        item.ProfileKey = t1.$index(jsonMap, "key");
        item.UserIDs = t1.$index(jsonMap, "userIds");
        item.Roles = t1.$index(jsonMap, "roles");
        return item;
      }}
  },
  LocalSettingsDO: {
    "^": "LocalDO;me@,profile@,offline@,moreAnimations<,lang>,lastProfileId<,token@,login?,Id,observable$Observable$_changes,observable$Observable$_values,observable$Observable$_records",
    toJsonMap$0: function() {
      var map, t1;
      map = K.LocalDO.prototype.toJsonMap$0.call(this);
      t1 = this.me;
      map.$indexSet(0, "me", t1 == null ? null : t1.toJsonMap$0());
      t1 = this.profile;
      map.$indexSet(0, "profile", t1 == null ? null : t1.toJsonMap$0());
      map.$indexSet(0, "offline", this.offline);
      map.$indexSet(0, "moreAnimations", this.moreAnimations);
      map.$indexSet(0, "lang", this.lang);
      map.$indexSet(0, "lastProfileId", this.lastProfileId);
      map.$indexSet(0, "token", this.token);
      map.$indexSet(0, "login", this.login);
      return map;
    },
    static: {LocalSettingsDO_fromJsonMap: function(jsonMap, item) {
        var t1;
        if (jsonMap == null)
          return;
        item = new K.LocalSettingsDO(null, null, true, true, "en", null, null, null, null, null, null, null);
        t1 = J.getInterceptor$asx(jsonMap);
        item.Id = t1.$index(jsonMap, "Id");
        item.profile = K.ProfileDO_fromJsonMap(t1.$index(jsonMap, "profile"), null);
        item.me = K.UserDO_fromJsonMap(t1.$index(jsonMap, "me"), null);
        item.offline = t1.$index(jsonMap, "offline") == null ? true : t1.$index(jsonMap, "offline");
        item.moreAnimations = t1.$index(jsonMap, "moreAnimations") == null ? true : t1.$index(jsonMap, "moreAnimations");
        item.lang = t1.$index(jsonMap, "lang");
        item.lastProfileId = t1.$index(jsonMap, "lastProfileId");
        item.token = t1.$index(jsonMap, "token");
        item.login = t1.$index(jsonMap, "login");
        return item;
      }}
  },
  BlobDO: {
    "^": "GeneralDO;Data,name>,type,Sync,SyncId,Version,Id,observable$Observable$_changes,observable$Observable$_values,observable$Observable$_records",
    toJsonMap$0: function() {
      var map = K.GeneralDO.prototype.toJsonMap$0.call(this);
      map.$indexSet(0, "data", this.Data);
      map.$indexSet(0, "type", this.type);
      map.$indexSet(0, "name", this.name);
      return map;
    },
    static: {BlobDO_fromJsonMap: function(jsonMap, item) {
        var t1;
        if (jsonMap == null)
          return;
        item = new K.BlobDO(null, null, null, null, null, null, null, null, null, null);
        t1 = J.getInterceptor$asx(jsonMap);
        item.Id = t1.$index(jsonMap, "id");
        item.Sync = t1.$index(jsonMap, "sync");
        item.SyncId = t1.$index(jsonMap, "syncId");
        item.Version = t1.$index(jsonMap, "version") != null ? J.floor$0$n(t1.$index(jsonMap, "version")) : 0;
        item.Data = t1.$index(jsonMap, "data");
        item.name = t1.$index(jsonMap, "name");
        item.type = t1.$index(jsonMap, "type");
        return item;
      }}
  },
  LocalDataStorage: {
    "^": "Object;batchStartCtrl<,batchEndCtrl<",
    LocalDataStorage$0: function($T) {
      var t1 = $.get$ItinnDataContext__singleton();
      this.ctx = t1;
      this.LOG = t1.LOG;
      t1 = P.StreamController_StreamController(null, null, null, null, false, null);
      this.updateCtrl = t1;
      this.onUpdate = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]).asBroadcastStream$0();
      t1 = P.StreamController_StreamController(null, null, null, null, false, null);
      this.insertCtrl = t1;
      this.onInsert = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]).asBroadcastStream$0();
      t1 = P.StreamController_StreamController(null, null, null, null, false, null);
      this.removeCtrl = t1;
      this.onRemove = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]).asBroadcastStream$0();
      t1 = P.StreamController_StreamController(null, null, null, null, false, null);
      this.clearAllCtrl = t1;
      this.onClearAll = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]).asBroadcastStream$0();
      t1 = P.StreamController_StreamController(null, null, null, null, false, null);
      this.batchStartCtrl = t1;
      this.onBatchStart = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]).asBroadcastStream$0();
      t1 = P.StreamController_StreamController(null, null, null, null, false, null);
      this.batchEndCtrl = t1;
      this.onBatchEnd = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]).asBroadcastStream$0();
    }
  },
  LDLocalStorage: {
    "^": "LocalDataStorage;",
    _toDbObj$1: function(item) {
      var map = this.toJsonMap$1(item);
      if (this._saveStrings === true)
        return C.JsonCodec_null_null.encode$1(map);
      else
        return map;
    },
    _fromDbObj$1: function(json_or_map) {
      if (json_or_map == null)
        return;
      else
        return this.fromJsonMap$1(this._saveStrings === true ? C.JsonCodec_null_null.decode$1(json_or_map) : json_or_map);
    },
    init$1$ctx: function(ctx) {
      var t1, c;
      this.LOG.fine$1("Initializing store " + H.S(this.tableName) + " in " + this.dbName + " (" + J.toString$0(this.store) + ")");
      t1 = P.bool;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]);
      this.store.open$0(0).then$2$onError(new K.LDLocalStorage_init_closure(this, c), new K.LDLocalStorage_init_closure0(this, c));
      return c.future;
    },
    init$0: function() {
      return this.init$1$ctx(null);
    },
    get$openIfNeed: function() {
      var t1 = this._openF;
      if (t1 == null)
        if (this.store._isOpen) {
          t1 = P._Future$immediate(true, null);
          this._openF = t1;
        } else {
          t1 = this.init$0();
          this._openF = t1;
    ...
    getById$1: function(id) {
      var c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      this.get$openIfNeed().then$1(new K.LDLocalStorage_getById_closure(this, id, c));
      return c.future;
    },
    getAll$0: function() {
      var c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      this.get$openIfNeed().then$1(new K.LDLocalStorage_getAll_closure(this, c));
      return c.future;
    },
    insert$2$generateId: function(_, item, generateId) {
      var c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      this.get$openIfNeed().then$1(new K.LDLocalStorage_insert_closure(this, item, generateId, c));
      return c.future;
    },
    update$3$oldId$quiet: function(_, item, oldId, quiet) {
      var c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      this.get$openIfNeed().then$1(new K.LDLocalStorage_update_closure(this, item, oldId, quiet, c));
      return c.future;
    },
    update$1: function($receiver, item) {
      return this.update$3$oldId$quiet($receiver, item, null, false);
    },
    clear$0: function(_) {
      var c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      this.get$openIfNeed().then$1(new K.LDLocalStorage_clear_closure(this, c));
      return c.future;
    },
    LDLocalStorage$3$dbName$indexes: function(tableName, dbName, indexes, box_0, $T) {
      var t1 = this.tableName;
      if (t1 == null) {
        t1 = new H.TypeImpl(H.getRuntimeTypeString(this), null).toString$0(0);
        this.tableName = t1;
      }
      if (!C.JSArray_methods.contains$1($.get$LDLocalStorage_allTableNames(), t1))
        $.get$LDLocalStorage_allTableNames().push(this.tableName);
      box_0.ldindexes_0 = null;
      this.store = Z.Store_Store(this.dbName, this.tableName, null, null, null);
      this._saveStrings = !(!!(window.indexedDB || window.webkitIndexedDB || window.mozIndexedDB) || !!window.openDatabase);
    }
  },
  LDLocalStorage_closure: {
    "^": "Closure:55;box_0",
    call$1: function(idx) {
      var t1, t2;
      t1 = this.box_0.ldindexes_0;
      t2 = new Z.IndexDesc(idx.get$name(idx), idx.get$keyPath(idx), false, false, "TEXT");
      t2.multi = idx.get$multi();
      t2.unique = idx.get$unique(idx);
      t1.push(t2);
    },
    $isFunction: true
  },
  LDLocalStorage_init_closure: {
    "^": "Closure:55;this_0,c_1",
    call$1: [function(ok) {
      var t1 = this.this_0;
      t1.LOG.fine$1("Initialization of store " + H.S(t1.tableName) + " in " + t1.dbName + " (" + J.toString$0(t1.store) + ") successful");
      t1 = this.c_1.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(ok);
    }, "call$1", null, 2, 0, null, 58, "call"],
    $isFunction: true
  },
  LDLocalStorage_init_closure0: {
    "^": "Closure:55;this_2,c_3",
    call$1: [function(err) {
      var t1 = this.this_2;
      t1.LOG.severe$1("Initialization of store " + H.S(t1.tableName) + " in " + t1.dbName + " (" + J.toString$0(t1.store) + ") FAILED");
      t1 = this.c_3.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
  ...
  LDLocalStorage_getById_closure: {
    "^": "Closure:55;this_0,id_1,c_2",
    call$1: [function(_) {
      var t1, t2, t3;
      t1 = this.id_1;
      t2 = t1 == null || J.get$isEmpty$asx(t1) === true;
      t3 = this.this_0;
      if (t2) {
        t3.LOG.warning$1("getById with null or empty id: " + H.S(t1) + " from " + H.S(t3.tableName) + " ");
        t1 = this.c_2.future;
        if (t1._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t1._asyncComplete$1(null);
        ...
        t2 = t3.store;
        if (!t2._isOpen)
          H.throwExpression(P.StateError$(J.get$runtimeType$(t2).toString$0(0) + " is not open"));
        t2._getByKey$1(t1).then$1(new K.LDLocalStorage_getById__closure(t3, t1, this.c_2));
      }
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  LDLocalStorage_getById__closure: {
    "^": "Closure:55;this_3,id_4,c_5",
    call$1: [function(json) {
      var t1, obj, t2;
      t1 = this.this_3;
      obj = t1._fromDbObj$1(json);
      t2 = this.c_5;
      if (obj != null) {
        obj.Id = this.id_4;
        t1 = t2.future;
        ...
        t1.LOG.warning$1("getById returns null from " + H.S(t1.tableName) + " ");
        t1 = t2.future;
        if (t1._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t1._asyncComplete$1(null);
  ...
  LDLocalStorage_getAll_closure: {
    ...
    call$1: [function(_) {
      ...
      if (!t2._isOpen)
        H.throwExpression(P.StateError$(J.get$runtimeType$(t2).toString$0(0) + " is not open"));
      t2._all$0().listen$2$onDone(new K.LDLocalStorage_getAll__closure(t1, data), new K.LDLocalStorage_getAll__closure0(this.c_1, data));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  LDLocalStorage_getAll__closure: {
    "^": "Closure:55;this_2,data_3",
    call$1: [function(json) {
      var obj;
      if (json != null) {
        obj = this.this_2._fromDbObj$1(json);
        if (obj != null)
          this.data_3.push(obj);
      }
    }, "call$1", null, 2, 0, null, 88, "call"],
    $isFunction: true
  },
  LDLocalStorage_getAll__closure0: {
    "^": "Closure:10;c_4,data_5",
    call$0: [function() {
      var t1 = this.c_4.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(this.data_5);
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  LDLocalStorage_insert_closure: {
    "^": "Closure:55;this_0,item_1,generateId_2,c_3",
    call$1: [function(_) {
      var t1, t2, json, t3;
      if (this.generateId_2) {
        t1 = this.this_0;
        t2 = t1.idPrefix + ++t1.lastIdCounter;
        this.item_1.Id = t2;
        t1.LOG.finest$1("generated id: " + t2);
      }
      t1 = this.this_0;
      t2 = this.item_1;
      json = t1._toDbObj$1(t2);
      t3 = this.c_3;
      t1.store.save$2(0, json, t2.Id).then$2$onError(new K.LDLocalStorage_insert__closure(t1, t2, t3), new K.LDLocalStorage_insert__closure0(t3));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  LDLocalStorage_insert__closure: {
    "^": "Closure:55;this_4,item_5,c_6",
    call$1: [function(id) {
      var t1, t2, t3;
      t1 = this.this_4;
      t1.LOG.finest$1("Item ADDed to " + H.S(t1.tableName) + " with id: " + H.S(id));
      t2 = this.item_5;
      t3 = this.c_6.future;
      if (t3._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t3._asyncComplete$1(t2);
      if (!t1.suppressStreams) {
        t1 = t1.insertCtrl;
        if (t1._state >= 4)
          H.throwExpression(t1._badEventState$0());
        t3 = t1._state;
  ...
  LDLocalStorage_insert__closure0: {
    "^": "Closure:55;c_7",
    call$1: [function(err) {
      this.c_7.completeError$1(err);
    }, "call$1", null, 2, 0, null, 87, "call"],
    $isFunction: true
  },
  LDLocalStorage_update_closure: {
    "^": "Closure:55;this_0,item_1,oldId_2,quiet_3,c_4",
    call$1: [function(_) {
      var t1, t2, json, t3;
      t1 = this.this_0;
      t2 = this.item_1;
      json = t1._toDbObj$1(t2);
      t3 = this.c_4;
      t1.store.save$2(0, json, t2.get$Id()).then$2$onError(new K.LDLocalStorage_update__closure(t1, t2, this.oldId_2, this.quiet_3, t3), new K.LDLocalStorage_update__closure0(t3));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  LDLocalStorage_update__closure: {
    "^": "Closure:55;this_5,item_6,oldId_7,quiet_8,c_9",
    call$1: [function(id) {
      var t1, t2, t3, t4;
      t1 = this.this_5;
      t1.LOG.finest$1("Item PUT to " + H.S(t1.tableName) + " with id: " + H.S(id) + " ");
      t2 = this.oldId_7;
      if (t2 != null && !J.$eq(this.item_6.get$Id(), t2)) {
        t3 = t1.store;
        if (!t3._isOpen)
          H.throwExpression(P.StateError$(J.get$runtimeType$(t3).toString$0(0) + " is not open"));
        t4 = this.c_9;
        t3._removeByKey$1(t2).then$2$onError(new K.LDLocalStorage_update___closure(t1, this.item_6, this.quiet_8, t4), new K.LDLocalStorage_update___closure0(t4));
      } else {
        t2 = this.item_6;
        t3 = this.c_9.future;
        if (t3._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t3._asyncComplete$1(t2);
        if (!this.quiet_8 && !t1.suppressStreams) {
          t1 = t1.updateCtrl;
          if (t1._state >= 4)
            H.throwExpression(t1._badEventState$0());
          t3 = t1._state;
  ...
  LDLocalStorage_update___closure: {
    "^": "Closure:55;this_10,item_11,quiet_12,c_13",
    call$1: [function(_) {
      var t1, t2, t3;
      t1 = this.item_11;
      t2 = this.c_13.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t2._asyncComplete$1(t1);
      if (!this.quiet_12 && !this.this_10.suppressStreams) {
        t2 = this.this_10.updateCtrl;
        if (t2._state >= 4)
        ...
        if ((t3 & 1) !== 0)
          ...
          t2._ensurePendingEvents$0().add$1(0, H.setRuntimeTypeInfo(new P._DelayedData(t1, null), [H.getRuntimeTypeArgument(t2, "_StreamController", 0)]));
      }
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  LDLocalStorage_update___closure0: {
    "^": "Closure:55;c_14",
    call$1: [function(err) {
      this.c_14.completeError$1(err);
    }, "call$1", null, 2, 0, null, 87, "call"],
    $isFunction: true
  },
  LDLocalStorage_update__closure0: {
    "^": "Closure:55;c_15",
    call$1: [function(err) {
      this.c_15.completeError$1(err);
    }, "call$1", null, 2, 0, null, 87, "call"],
    $isFunction: true
  },
  LDLocalStorage_clear_closure: {
    "^": "Closure:55;this_0,c_1",
    call$1: [function(_) {
      var t1, t2, t3;
      t1 = this.this_0;
      ...
      if (!t2._isOpen)
        H.throwExpression(P.StateError$(J.get$runtimeType$(t2).toString$0(0) + " is not open"));
      t3 = this.c_1;
      t2._nuke$0().then$2$onError(new K.LDLocalStorage_clear__closure(t1, t3), new K.LDLocalStorage_clear__closure0(t3));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  LDLocalStorage_clear__closure: {
    "^": "Closure:55;this_2,c_3",
    call$1: [function(_) {
      var t1, t2;
      t1 = this.this_2;
      t1.lastIdCounter = 0;
      t1.LOG.finest$1("Store " + H.S(t1.tableName) + " in " + t1.dbName + " cleared");
      t2 = this.c_3.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      ...
      if (!t1.suppressStreams) {
        ...
        if ((t2 & 1) !== 0)
          ...
          t1._ensurePendingEvents$0().add$1(0, H.setRuntimeTypeInfo(new P._DelayedData(true, null), [H.getRuntimeTypeArgument(t1, "_StreamController", 0)]));
      }
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  LDLocalStorage_clear__closure0: {
    "^": "Closure:55;c_4",
    call$1: [function(err) {
      this.c_4.completeError$1(err);
    }, "call$1", null, 2, 0, null, 87, "call"],
    $isFunction: true
  },
  LDStorage: {
    "^": "LDLocalStorage;version>",
    getVersion$1$deep: function(deep) {
      var t1, c, t2;
      t1 = P.$int;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]);
      if (deep)
        this.getAll$1$inclDeleted(true).then$1(new K.LDStorage_getVersion_closure(this, c));
      else {
        t1 = this.version;
        t2 = c.future;
        if (t2._state !== 0)
    ...
    merge$4$item$oldId$sync$syncId: function(item, oldId, sync, syncId) {
      var t1, t2, c;
      t1 = {};
      t1.oldId_0 = oldId;
      t2 = H.getRuntimeTypeArgument(this, "LDStorage", 0);
      ...
      this.LOG.finest$1("Merging item with ID: " + H.S(t2) + ". Item:" + C.JsonCodec_null_null.encode$1(item.toJsonMap$0()));
      this.getById$2$inclDeleted(t1.oldId_0, true).then$1(new K.LDStorage_merge_closure(t1, this, item, sync, c));
      return c.future;
    },
    merge$2$item$oldId: function(item, oldId) {
      return this.merge$4$item$oldId$sync$syncId(item, oldId, true, null);
    },
    isSync$1$deep: function(deep) {
      var c, t1, t2;
      ...
      if (deep) {
        ...
        t1._all$0().listen$2$onDone(new K.LDStorage_isSync_closure(this), new K.LDStorage_isSync_closure0(this, c));
      } else {
        t1 = this.synced;
        t2 = c.future;
        if (t2._state !== 0)
    ...
    getById$2$inclDeleted: function(id, inclDeleted) {
      return K.LDLocalStorage.prototype.getById$1.call(this, id).then$1(new K.LDStorage_getById_closure(this, inclDeleted));
    },
    getAll$1$inclDeleted: function(inclDeleted) {
      return K.LDLocalStorage.prototype.getAll$0.call(this).then$1(new K.LDStorage_getAll_closure(inclDeleted));
    },
    update$4$oldId$quiet$sync: function(_, item, oldId, quiet, sync) {
      var t1, t2;
      if (!J.$eq(item.get$Sync(), "create") || sync === true)
        item.set$Sync(sync);
      if (sync !== true) {
        this.synced = false;
        if (!this.suppressStreams) {
          t1 = this.syncNeedCtrl;
          if (t1._state >= 4)
            H.throwExpression(t1._badEventState$0());
          t2 = t1._state;
          if ((t2 & 1) !== 0)
      ...
      return K.LDLocalStorage.prototype.update$3$oldId$quiet.call(this, this, item, oldId, quiet);
    },
    update$3$quiet$sync: function($receiver, item, quiet, sync) {
      return this.update$4$oldId$quiet$sync($receiver, item, null, quiet, sync);
    },
    update$3$oldId$sync: function($receiver, item, oldId, sync) {
      return this.update$4$oldId$quiet$sync($receiver, item, oldId, false, sync);
    },
    remove$2$sync: function(_, item, sync) {
      var c, t1, t2;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      if (item != null)
        if (J.$eq(item.get$Sync(), "create") || sync === true) {
          ...
          if (!t1._isOpen)
            H.throwExpression(P.StateError$(J.get$runtimeType$(t1).toString$0(0) + " is not open"));
          t1._removeByKey$1(t2).then$2$onError(new K.LDStorage_remove_closure(this, item, c), new K.LDStorage_remove_closure0(c));
        } else {
          item.set$Sync("delete");
          this.update$3$quiet$sync(0, item, true, "delete").then$2$onError(new K.LDStorage_remove_closure1(this, c), new K.LDStorage_remove_closure2(c));
        }
      else
        c.completeError$1("No item.");
      return c.future;
    },
    remove$1: function($receiver, item) {
      return this.remove$2$sync($receiver, item, "delete");
    },
    clear$0: function(_) {
      return K.LDLocalStorage.prototype.clear$0.call(this, this).then$1(new K.LDStorage_clear_closure(this));
    },
    LDStorage$3$dbName$indexes: function(tableName, dbName, indexes, $T) {
      var t1 = P.StreamController_StreamController(null, null, null, null, false, null);
      this.idchangeCtrl = t1;
      this.onIdChange = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]).asBroadcastStream$0();
      t1 = P.StreamController_StreamController(null, null, null, null, false, null);
      this.syncNeedCtrl = t1;
      this.onSyncNeed = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]).asBroadcastStream$0();
    }
  },
  LDStorage_getVersion_closure: {
    "^": "Closure:55;this_0,c_1",
    call$1: [function(all) {
      var t1, m, item, t2;
      if (all != null && J.get$isNotEmpty$asx(all)) {
        for (t1 = J.get$iterator$ax(all), m = 0; t1.moveNext$0();) {
          item = t1.get$current();
          m = P.max(m, item.get$Version() == null ? 0 : item.get$Version());
        }
        this.this_0.version = m;
      }
      t1 = this.this_0.version;
      t2 = this.c_1.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t2._asyncComplete$1(t1);
  ...
  LDStorage_merge_closure: {
    "^": "Closure:55;box_0,this_1,item_2,sync_3,c_4",
    call$1: [function(child) {
      var child0, t1, t2, t3, t4, generateId;
      child0 = this.item_2;
      t1 = this.this_1;
      t2 = this.sync_3;
      if (child == null) {
        if (!t2) {
          ...
          if (!t1.suppressStreams) {
            ...
            if ((t4 & 1) !== 0)
              ...
              t3._ensurePendingEvents$0().add$1(0, H.setRuntimeTypeInfo(new P._DelayedData(true, null), [H.getRuntimeTypeArgument(t3, "_StreamController", 0)]));
          }
          generateId = true;
        } else
          generateId = false;
        child0.Sync = t2;
        K.LDLocalStorage.prototype.insert$2$generateId.call(t1, t1, child0, generateId).then$1(new K.LDStorage_merge__closure(t1, this.c_4));
      } else {
        t3 = this.box_0;
        t4 = J.$eq(child0.Id, t3.oldId_0);
        child.merge$1(child0);
        t1.update$3$oldId$sync(0, child, t3.oldId_0, t2).then$1(new K.LDStorage_merge__closure0(t3, t1, this.c_4, !t4));
      }
    }, "call$1", null, 2, 0, null, 91, "call"],
    $isFunction: true
  },
  LDStorage_merge__closure: {
    "^": "Closure;this_5,c_6",
    call$1: [function(savedItem) {
      var t1;
      this.this_5.LOG.finest$1("Merged (Inserted) item :" + savedItem.toJson$0());
      t1 = this.c_6.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(savedItem);
    }, "call$1", null, 2, 0, null, 92, "call"],
    $isFunction: true,
    $signature: function() {
      return H.computeSignature(function(T) {
        return {func: "dynamic__T0", args: [T]};
      }, this.this_5, "LDStorage");
    }
  },
  LDStorage_merge__closure0: {
    "^": "Closure;box_0,this_7,c_8,idChanged_9",
    call$1: [function(savedItem) {
      var t1, t2, t3;
      t1 = this.this_7;
      t1.LOG.finest$1("Merged (UPDATED) item :" + savedItem.toJson$0());
      if (this.idChanged_9) {
        t1 = t1.idchangeCtrl;
        t2 = new K.StoreChange(this.box_0.oldId_0, savedItem.get$Id());
        if (t1._state >= 4)
          H.throwExpression(t1._badEventState$0());
        t3 = t1._state;
        if ((t3 & 1) !== 0)
    ...
    $signature: function() {
      return H.computeSignature(function(T) {
        return {func: "dynamic__T0", args: [T]};
      }, this.this_7, "LDStorage");
    }
  },
  LDStorage_isSync_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(map) {
      var t1, obj;
      if (map != null) {
        t1 = this.this_0;
        obj = t1._fromDbObj$1(map);
        if (obj != null && !J.$eq(obj.get$Sync(), true)) {
          t1.LOG.finest$1("Found not synced child: " + H.S(map));
          t1.synced = false;
        }
      }
  ...
  LDStorage_isSync_closure0: {
    "^": "Closure:10;this_1,c_2",
    call$0: [function() {
      var t1, t2;
      t1 = this.this_1.synced;
      t2 = this.c_2.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t2._asyncComplete$1(t1);
  ...
  LDStorage_getById_closure: {
    "^": "Closure:55;this_0,inclDeleted_1",
    call$1: [function(obj) {
      var t1, t2;
      t1 = obj != null;
      if (t1)
        t2 = this.inclDeleted_1 || !J.$eq(obj.get$Sync(), "delete");
      else
        t2 = false;
      if (t2)
        return obj;
        ...
        if (t1)
          this.this_0.LOG.warning$1("getById returns null (item deleted and ready to sync");
        return;
      }
    }, "call$1", null, 2, 0, null, 94, "call"],
    $isFunction: true
  },
  LDStorage_getAll_closure: {
    "^": "Closure:55;inclDeleted_0",
    call$1: [function(all) {
      var all2;
      if (!this.inclDeleted_0 && all != null) {
        all2 = [];
        J.forEach$1$ax(all, new K.LDStorage_getAll__closure(all2));
        return all2;
      } else
        return all;
    }, "call$1", null, 2, 0, null, 90, "call"],
  ...
  LDStorage_getAll__closure: {
    "^": "Closure:55;all2_1",
    call$1: [function(obj) {
      if (!J.$eq(obj.get$Sync(), "delete"))
        this.all2_1.push(obj);
    }, "call$1", null, 2, 0, null, 94, "call"],
    $isFunction: true
  },
  LDStorage_remove_closure: {
    "^": "Closure:55;this_0,item_1,c_2",
    call$1: [function(_) {
      var t1, t2, t3;
      t1 = this.this_0;
      t2 = this.item_1;
      t1.LOG.finest$1("Item HARD DELETE with id: " + H.S(t2.get$Id()));
      t3 = this.c_2.future;
      if (t3._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
  ...
  LDStorage_remove_closure0: {
    "^": "Closure:55;c_3",
    call$1: [function(err) {
      this.c_3.completeError$1(err);
    }, "call$1", null, 2, 0, null, 87, "call"],
    $isFunction: true
  },
  LDStorage_remove_closure1: {
    "^": "Closure:55;this_4,c_5",
    call$1: [function(item) {
      var t1, t2, t3;
      t1 = this.this_4;
      t1.LOG.finest$1("Item MARK DELETE with id: " + H.S(item.get$Id()));
      t2 = this.c_5.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t2._asyncComplete$1(true);
  ...
  LDStorage_remove_closure2: {
    "^": "Closure:55;c_6",
    call$1: [function(err) {
      this.c_6.completeError$1(err);
    }, "call$1", null, 2, 0, null, 87, "call"],
    $isFunction: true
  },
  LDStorage_clear_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(_) {
      var t1 = this.this_0;
      t1.version = 0;
  ...
  StorageCtrl: {
    "^": "Object;storeUser,storeClob,storeSett,storeThumbnailClob,onSyncNeed,syncNeedCtrl,dbName",
    init$1$ctx: function(ctx) {
      return this.storeSett.init$1$ctx(ctx).then$1(new K.StorageCtrl_init_closure(this));
    },
    init$0: function() {
      return this.init$1$ctx(null);
    },
    clearAll$1$deep: function(deep) {
      var t1, t2, c;
      t1 = {};
      t2 = P.bool;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t2)), [t2]);
      t1.gOK_0 = true;
      this.storeUser.clear$0(0).then$1(new K.StorageCtrl_clearAll_closure(t1, this, deep, c));
      return c.future;
    },
    clearAll$0: function() {
      return this.clearAll$1$deep(false);
    },
    settAction$1: function(action) {
      var t1, c;
      t1 = K.LocalSettingsDO;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]);
      this.storeSett.getSett$0().then$1(new K.StorageCtrl_settAction_closure(this, action, c));
      return c.future;
    },
    checkSave$1$deep: function(deep) {
      var t1 = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]).future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(true);
      t1.then$1(new K.StorageCtrl_checkSave_closure(this));
    },
    StorageCtrl$1: function(dbName) {
      var t1, t2, t3;
      t1 = this.dbName;
      t2 = K.UserDO;
      t3 = new K.UserStorage(true, 0, null, null, null, null, t1, "Users", null, null, null, null, 0, K.ItinnDataContext_randomStrings(7), null, null, false, null, null, null, null, null, null, null, null, null, null, null, null);
      t3.LocalDataStorage$0(t2);
      t3.LDLocalStorage$3$dbName$indexes("Users", t1, null, t2, {});
      t3.LDStorage$3$dbName$indexes("Users", t1, null, t2);
      this.storeUser = t3;
      t3 = K.BlobDO;
      t2 = new K.ClobStorage(null, true, 0, null, null, null, null, t1, "Clobs", null, null, null, null, 0, K.ItinnDataContext_randomStrings(7), null, null, false, null, null, null, null, null, null, null, null, null, null, null, null);
      t2.LocalDataStorage$0(t3);
      t2.LDLocalStorage$3$dbName$indexes("Clobs", t1, null, t3, {});
      t2.LDStorage$3$dbName$indexes("Clobs", t1, null, t3);
      this.storeClob = t2;
      t2 = K.LocalSettingsDO;
      t3 = new K.CommonSettStorage("settings", null, t1, "Sett", null, null, null, null, 0, K.ItinnDataContext_randomStrings(7), null, null, false, null, null, null, null, null, null, null, null, null, null, null, null);
      t3.LocalDataStorage$0(t2);
      t3.LDLocalStorage$3$dbName$indexes("Sett", t1, null, t2, {});
      this.storeSett = t3;
      t3 = K.BlobDO;
      t2 = new K.ThumbnailClobStorage(this.storeClob, t1, "ThmbClobs", null, null, null, null, 0, K.ItinnDataContext_randomStrings(7), null, null, false, null, null, null, null, null, null, null, null, null, null, null, null);
      t2.LocalDataStorage$0(t3);
      t2.LDLocalStorage$3$dbName$indexes("ThmbClobs", t1, null, t3, {});
      this.storeThumbnailClob = t2;
      this.storeClob.thumbClobStorage = t2;
      t2 = P.StreamController_StreamController(null, null, null, null, false, null);
      this.syncNeedCtrl = t2;
      this.onSyncNeed = H.setRuntimeTypeInfo(new P._ControllerStream(t2), [null]).asBroadcastStream$0();
    }
  },
  StorageCtrl_init_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(_) {
      var t1 = this.this_0;
      return t1.storeUser.init$0().then$1(new K.StorageCtrl_init__closure(t1));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  StorageCtrl_init__closure: {
    "^": "Closure:55;this_1",
    call$1: [function(_) {
      var t1 = this.this_1;
      t1.storeUser.onSyncNeed.listen$1(new K.StorageCtrl_init___closure(t1));
      return t1.storeClob.init$0().then$1(new K.StorageCtrl_init___closure0(t1));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  StorageCtrl_init___closure: {
    "^": "Closure:55;this_2",
    call$1: [function($event) {
      var t1, t2;
      t1 = this.this_2.syncNeedCtrl;
      if (t1._state >= 4)
        H.throwExpression(t1._badEventState$0());
      t2 = t1._state;
      if ((t2 & 1) !== 0)
        ...
        t1._ensurePendingEvents$0().add$1(0, H.setRuntimeTypeInfo(new P._DelayedData($event, null), [H.getRuntimeTypeArgument(t1, "_StreamController", 0)]));
    }, "call$1", null, 2, 0, null, 96, "call"],
    $isFunction: true
  },
  StorageCtrl_init___closure0: {
    "^": "Closure:55;this_3",
    call$1: [function(_) {
      var t1 = this.this_3;
      t1.storeClob.onSyncNeed.listen$1(new K.StorageCtrl_init____closure(t1));
      return true;
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  StorageCtrl_init____closure: {
    "^": "Closure:55;this_4",
    call$1: [function($event) {
      var t1, t2;
      t1 = this.this_4.syncNeedCtrl;
      if (t1._state >= 4)
        H.throwExpression(t1._badEventState$0());
      t2 = t1._state;
      if ((t2 & 1) !== 0)
  ...
  StorageCtrl_clearAll_closure: {
    "^": "Closure:55;box_0,this_1,deep_2,c_3",
    call$1: [function(ok) {
      var t1;
      if (ok !== true)
        this.box_0.gOK_0 = false;
      t1 = this.this_1;
      t1.storeClob.clear$0(0).then$1(new K.StorageCtrl_clearAll__closure(this.box_0, t1, this.deep_2, this.c_3));
    }, "call$1", null, 2, 0, null, 58, "call"],
    $isFunction: true
  },
  StorageCtrl_clearAll__closure: {
    "^": "Closure:55;box_0,this_4,deep_5,c_6",
    call$1: [function(ok) {
      var t1, t2;
      if (ok !== true)
        this.box_0.gOK_0 = false;
      ...
      t2 = this.box_0;
      if (this.deep_5)
        this.this_4.storeSett.clear$0(0).then$1(new K.StorageCtrl_clearAll___closure(t2, t1));
      else {
        t2 = t2.gOK_0;
        t1 = t1.future;
        if (t1._state !== 0)
  ...
  StorageCtrl_clearAll___closure: {
    "^": "Closure:55;box_0,c_7",
    call$1: [function(ok) {
      var t1, t2;
      if (ok !== true)
        this.box_0.gOK_0 = false;
  ...
  StorageCtrl_settAction_closure: {
    "^": "Closure:55;this_0,action_1,c_2",
    call$1: [function(sett) {
      var f, t1, t2, t3;
      f = this.action_1.call$1(sett);
      t1 = f != null && !!J.getInterceptor(f).$isFuture;
      t2 = this.this_0;
      t3 = this.c_2;
      if (t1)
        f.then$1(new K.StorageCtrl_settAction__closure(t2, t3, sett));
      else
        t2.storeSett.setSett$1(sett).then$1(new K.StorageCtrl_settAction__closure0(t3));
    }, "call$1", null, 2, 0, null, 97, "call"],
    $isFunction: true
  },
  StorageCtrl_settAction__closure: {
    "^": "Closure:55;this_3,c_4,sett_5",
    call$1: [function(_) {
      this.this_3.storeSett.setSett$1(this.sett_5).then$1(new K.StorageCtrl_settAction___closure(this.c_4));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  StorageCtrl_settAction___closure: {
    "^": "Closure:55;c_6",
    call$1: [function(sett) {
      var t1 = this.c_6.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(sett);
    }, "call$1", null, 2, 0, null, 97, "call"],
    $isFunction: true
  },
  StorageCtrl_settAction__closure0: {
    "^": "Closure:55;c_7",
    call$1: [function(sett) {
      var t1 = this.c_7.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(sett);
    }, "call$1", null, 2, 0, null, 97, "call"],
  ...
  StorageCtrl_checkSave_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(synced) {
      var t1, t2, t3;
      t1 = this.this_0.syncNeedCtrl;
      t2 = synced !== true;
      if (t1._state >= 4)
        H.throwExpression(t1._badEventState$0());
      t3 = t1._state;
  ...
  UserStorage: {
    "^": "SyncStorage;synced,version,onSyncNeed,syncNeedCtrl,onIdChange,idchangeCtrl,dbName,tableName,store,_saveStrings,indexes,_openF,lastIdCounter,idPrefix,ctx,LOG,suppressStreams,onUpdate,updateCtrl,onInsert,insertCtrl,onRemove,removeCtrl,onClearAll,clearAllCtrl,onBatchStart,onBatchEnd,batchStartCtrl,batchEndCtrl",
    toJsonMap$1: function(item) {
      return item.toJsonMap$0();
    },
    fromJsonMap$1: function(map) {
      return K.UserDO_fromJsonMap(map, null);
    },
    $asSyncStorage: function() {
      return [K.UserDO];
    },
    $asLDStorage: function() {
      return [K.UserDO];
    },
    $asLDLocalStorage: function() {
      return [K.UserDO];
    },
    $asLocalDataStorage: function() {
      return [K.UserDO];
    }
  },
  ClobStorage: {
    "^": "SyncStorage;thumbClobStorage,synced,version,onSyncNeed,syncNeedCtrl,onIdChange,idchangeCtrl,dbName,tableName,store,_saveStrings,indexes,_openF,lastIdCounter,idPrefix,ctx,LOG,suppressStreams,onUpdate,updateCtrl,onInsert,insertCtrl,onRemove,removeCtrl,onClearAll,clearAllCtrl,onBatchStart,onBatchEnd,batchStartCtrl,batchEndCtrl",
    fromJsonMap$1: function(map) {
      return K.BlobDO_fromJsonMap(map, null);
    },
    toJsonMap$1: function(item) {
      return item.toJsonMap$0();
    },
    clear$0: function(_) {
      return K.LDStorage.prototype.clear$0.call(this, this).then$1(new K.ClobStorage_clear_closure(this));
    },
    $asSyncStorage: function() {
      return [K.BlobDO];
    },
  ...
  ClobStorage_clear_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(ok) {
      var t1 = this.this_0.thumbClobStorage;
      if (t1 != null)
        return t1.clear$0(0).then$1(new K.ClobStorage_clear__closure(ok));
      else
        return ok;
    }, "call$1", null, 2, 0, null, 58, "call"],
    $isFunction: true
  },
  ClobStorage_clear__closure: {
    "^": "Closure:55;ok_1",
    call$1: [function(ok2) {
      return this.ok_1 === true && ok2 === true;
    }, "call$1", null, 2, 0, null, 99, "call"],
    $isFunction: true
  },
  ThumbnailClobStorage: {
    "^": "LocalStorage;clobStorage,dbName,tableName,store,_saveStrings,indexes,_openF,lastIdCounter,idPrefix,ctx,LOG,suppressStreams,onUpdate,updateCtrl,onInsert,insertCtrl,onRemove,removeCtrl,onClearAll,clearAllCtrl,onBatchStart,onBatchEnd,batchStartCtrl,batchEndCtrl",
    fromJsonMap$1: function(map) {
      return K.BlobDO_fromJsonMap(map, null);
    },
    toJsonMap$1: function(item) {
  ...
  CommonSettStorage: {
    "^": "LocalSettStorage;id,settings,dbName,tableName,store,_saveStrings,indexes,_openF,lastIdCounter,idPrefix,ctx,LOG,suppressStreams,onUpdate,updateCtrl,onInsert,insertCtrl,onRemove,removeCtrl,onClearAll,clearAllCtrl,onBatchStart,onBatchEnd,batchStartCtrl,batchEndCtrl",
    getDefaultSettings$0: function() {
      return new K.LocalSettingsDO(null, null, true, true, "en", null, null, null, null, null, null, null);
    },
    toJsonMap$1: function(item) {
      return item.toJsonMap$0();
    },
    fromJsonMap$1: function(map) {
      return K.LocalSettingsDO_fromJsonMap(map, null);
    },
    $asLocalSettStorage: function() {
      return [K.LocalSettingsDO];
    },
    $asLocalStorage: function() {
      return [K.LocalSettingsDO];
    },
  ...
  LocalSettStorage: {
    "^": "LocalStorage;",
    setSett$1: function(sett) {
      return this.update$1(0, sett).then$1(new K.LocalSettStorage_setSett_closure(this));
    },
    getSett$1$deep: function(deep) {
      var t1, c, t2;
      t1 = H.getRuntimeTypeArgument(this, "LocalSettStorage", 0);
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]);
      if (deep || this.settings == null) {
        t1 = this.id;
        if (t1 == null)
          this.getAll$0().then$1(new K.LocalSettStorage_getSett_closure(this, c));
        else
          this.getById$1(t1).then$1(new K.LocalSettStorage_getSett_closure0(this, c));
      } else {
        t1 = this.settings;
        t2 = c.future;
        if (t2._state !== 0)
    ...
    getSett$0: function() {
      return this.getSett$1$deep(false);
    }
  },
  LocalSettStorage_setSett_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(sett) {
      this.this_0.settings = sett;
      return sett;
    }, "call$1", null, 2, 0, null, 97, "call"],
    $isFunction: true
  },
  LocalSettStorage_getSett_closure: {
    "^": "Closure:55;this_0,c_1",
    call$1: [function(all) {
      var t1, t2, t3, ls;
      t1 = all != null && J.get$isNotEmpty$asx(all);
      t2 = this.this_0;
      t3 = this.c_1;
      if (t1) {
        t1 = J.getInterceptor$asx(all);
        t2.id = t1.$index(all, 0).get$Id();
        t2.settings = t1.$index(all, 0);
        t1 = t1.$index(all, 0);
        t2 = t3.future;
        if (t2._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        ...
        ls = t2.getDefaultSettings$0();
        ls.Id = "settings";
        t2.insert$2$generateId(0, ls, false).then$1(new K.LocalSettStorage_getSett__closure0(t2, t3));
      }
    }, "call$1", null, 2, 0, null, 90, "call"],
    $isFunction: true
  },
  LocalSettStorage_getSett__closure0: {
    "^": "Closure:55;this_2,c_3",
    call$1: [function(ls) {
      var t1 = this.this_2;
      t1.id = ls.get$Id();
      ...
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(ls);
    }, "call$1", null, 2, 0, null, 100, "call"],
    $isFunction: true
  },
  LocalSettStorage_getSett_closure0: {
    "^": "Closure:55;this_4,c_5",
    call$1: [function(ls) {
      var t1, t2;
      t1 = this.this_4;
      ...
      if (ls == null) {
        t1.id = null;
        t1.getSett$0().then$1(new K.LocalSettStorage_getSett__closure(t1, t2));
      } else {
        t1.settings = ls;
        t1 = t2.future;
        if (t1._state !== 0)
  ...
  LocalSettStorage_getSett__closure: {
    "^": "Closure:55;this_6,c_7",
    call$1: [function(ls) {
      var t1, t2;
      t1 = this.this_6;
      t2 = this.c_7;
      if (ls == null) {
        t1.LOG.severe$1("Cannot get LocalSettings ?!?");
        t1 = t1.getDefaultSettings$0();
        t2 = t2.future;
        if (t2._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t2._asyncComplete$1(t1);
...
["itinnutil", "package:itinnutil/itinnutil.dart", , A, {
  "^": "",
  Util_hideFull: function(el, immediate) {
    var c, t1;
    c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
    t1 = c.future;
    if (t1._state !== 0)
  ...
  ItinnUtilContext: {
    "^": "Object;i18n,LOG,dbName,storage,server,initialization,bus,mask,server401,serverMode,offlineMode,moreAnim,ANDROID,SERVER,uiLogEl,statusEl,start,_statusTimer",
    init$2$mask$uiLogEl: function(mask, uiLogEl) {
      var t1, t2;
      t1 = this.dbName;
      t2 = new K.StorageCtrl(null, null, null, null, null, null, t1);
      t2.StorageCtrl$1(t1);
      this.storage = t2;
      t2 = new A.ServerCtrl(null, null);
      t1 = new A.CommonServer(null, null);
      t1.Server$0();
      t2.common = t1;
      t2.users = A.UsersServer$();
      this.server = t2;
      t2 = new A.Initialization(null, null);
      t2.Initialization$0();
      this.initialization = t2;
      this.bus = new A.EventBus(P.LinkedHashMap_LinkedHashMap$_empty(null, null));
      return this.storage.init$0().then$1(new A.ItinnUtilContext_init_closure(this));
    },
    init$0: function() {
      return this.init$2$mask$uiLogEl(null, null);
    },
    status$1: [function(_, txt) {
    }, "call$1", "get$status", 2, 0, 34],
    static: {"^": "ItinnUtilContext_i", ItinnUtilContext_instance: function() {
        var t1, t2, t3;
        t1 = $.ItinnUtilContext_i;
        if (t1 == null) {
          t1 = H.JSSyntaxRegExp_makeNative("\\$[^\\$]*\\$", false, true, false);
          t2 = N.Logger_Logger("itinnutil");
          t3 = Date.now();
          new P.DateTime(t3, false).DateTime$_now$0();
          t3 = new A.ItinnUtilContext(new A.ItinnI18n(new H.JSSyntaxRegExp("\\$[^\\$]*\\$", t1, null, null), "en", "sk"), t2, "itinnDb", null, null, null, null, null, false, false, false, false, false, "", null, null, t3, null);
          $.ItinnUtilContext_i = t3;
          t1 = t3;
        }
        return t1;
      }}
  },
  ItinnUtilContext_init_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(ok) {
      if (ok !== true)
        return false;
      else
        return this.this_0.initialization.init$0();
    }, "call$1", null, 2, 0, null, 58, "call"],
    $isFunction: true
  },
  ItinnUtilContext_status_closure: {
    "^": "Closure:10;this_0",
    call$0: [function() {
      A.Util_hideFull(this.this_0.statusEl, true);
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  EventBus: {
    "^": "Object;_itinnutil$_map",
    static: {"^": "EventBus_EV_LOGIN,EventBus_EV_LOGOUT,EventBus_EV_ROLECHANGED"}
  },
  ItinnI18n: {
    "^": "Object;pattern,defaultLocale,locale",
    _getMessage$3: function(loc, key, replacements) {
      var str, t1, t2, rep;
      str = $.get$_trans().$index(0, loc).$index(0, key);
      if (str == null) {
        A.ItinnUtilContext_instance().LOG.severe$1("Err: no trans for key: " + H.S(key) + " and locale: " + H.S(loc));
        t1 = this.defaultLocale;
        str = !J.$eq(loc, t1) ? this._getMessage$3(t1, key, replacements) : key;
      } else if (replacements != null)
        for (t1 = H.setRuntimeTypeInfo(new H.ListIterator(replacements, replacements.length, 0, null), [H.getTypeArgumentByIndex(replacements, 0)]), t2 = this.pattern; t1.moveNext$0();) {
          rep = t1._current;
          if (rep != null) {
            if (typeof rep !== "string")
              H.throwExpression(P.ArgumentError$(rep));
            str = H.stringReplaceFirstUnchecked(str, t2, rep);
          }
        }
      return str;
    },
    $index: function(_, key) {
      return this._getMessage$3(this.locale, key, null);
    }
  },
  Initialization: {
    "^": "Object;ctx,LOG",
    initSettings$0: function() {
      return this.ctx.storage.storeSett.getSett$1$deep(false).then$1(new A.Initialization_initSettings_closure(this));
    },
    initServer$0: function() {
      this.LOG.finest$1("Init server starting. ServerMode:" + this.ctx.serverMode);
      return this.ctx.storage.storeSett.getSett$1$deep(false).then$1(new A.Initialization_initServer_closure(this));
    },
    init$0: function() {
      var t1, c;
      this.LOG.info$1("Common initialization started");
      t1 = P.bool;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]);
      this.LOG.finest$1("init settings");
      this.ctx.toString;
      this.initSettings$0().then$1(new A.Initialization_init_closure(this)).then$1(new A.Initialization_init_closure0(this, c));
      return c.future;
    },
    syncData$1$processErrors: function(processErrors) {
      var t1, c;
      t1 = P.bool;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]);
      this.ctx.server.sync$1$processErrors(processErrors).then$1(new A.Initialization_syncData_closure(this, c));
      return c.future;
    },
    syncData$0: function() {
      return this.syncData$1$processErrors(true);
    },
    initServerData$0: function() {
      var t1, c;
      t1 = P.bool;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]);
      this.ctx.storage.storeSett.getSett$0().then$1(new A.Initialization_initServerData_closure(this, c));
      return c.future;
    },
    initServerUser$0: function() {
      var t1, c;
      t1 = A.InitServerStatus;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]);
      this.ctx.storage.storeSett.getSett$0().then$1(new A.Initialization_initServerUser_closure(this, c));
      return c.future;
    },
    Initialization$0: function() {
      var t1 = A.ItinnUtilContext_instance();
      this.ctx = t1;
      this.LOG = t1.LOG;
    }
  },
  Initialization_initSettings_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(sett) {
      var t1, t2, t3;
      t1 = this.this_0;
      t1.ctx.moreAnim = sett.get$moreAnimations();
      t1.ctx.offlineMode = sett.get$offline();
      t2 = t1.ctx.i18n;
      t3 = J.getInterceptor$x(sett);
      t2.locale = t3.get$lang(sett) == null ? t1.ctx.i18n.defaultLocale : t3.get$lang(sett);
      t1 = t1.ctx;
      t2 = t1.mask;
      t1.i18n;
      t2.toString;
      ...
      P._Future$immediate(null, null);
    }, "call$1", null, 2, 0, null, 97, "call"],
    $isFunction: true
  },
  Initialization_initServer_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(sett) {
      var t1, t2, t3;
      t1 = this.this_0;
      t2 = t1.ctx;
      t2.serverMode = sett.get$me() != null && sett.get$me().Id != null || sett.get$token() != null;
      t2 = t1.ctx.serverMode;
      t3 = t1.LOG;
      if (t2) {
        t3.finest$1("starting initialization of server. ServerMode:true");
        return t1.initServerUser$0().then$1(new A.Initialization_initServer__closure(t1));
      } else {
        t3.finest$1("skipping initialization of server. ServerMode:false");
        return C.InitServerStatus_off;
      }
    }, "call$1", null, 2, 0, null, 97, "call"],
    $isFunction: true
  },
  Initialization_initServer__closure: {
    "^": "Closure:55;this_1",
    call$1: [function($status) {
      if (J.$eq($status, C.InitServerStatus_ok))
        return this.this_1.initServerData$0().then$1(new A.Initialization_initServer___closure($status));
      else
        return $status;
    }, "call$1", null, 2, 0, null, 101, "call"],
    $isFunction: true
  },
  Initialization_initServer___closure: {
    "^": "Closure:55;status_2",
    call$1: [function(ok) {
      if (ok === true)
        return this.status_2;
      else
        return C.InitServerStatus_err;
    }, "call$1", null, 2, 0, null, 58, "call"],
    $isFunction: true
  },
  Initialization_init_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(_) {
      var t1 = this.this_0;
      t1.ctx.toString;
      t1.LOG.finest$1("init settings DONE");
      t1.LOG.finest$1("init serverside");
      t1.ctx.toString;
      return t1.initServer$0();
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  Initialization_init_closure0: {
    "^": "Closure:102;this_1,c_2",
    call$1: [function($status) {
      var t1, t2;
      t1 = this.this_1;
      t1.LOG.finest$1("init serverside DONE! status: " + H.S(J.get$value$x($status)));
      t1.ctx.toString;
      t2 = this.c_2.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t2._asyncComplete$1(true);
      t1.LOG.info$1("Initialization completed successfully");
    }, "call$1", null, 2, 0, null, 101, "call"],
    $isFunction: true
  },
  Initialization_syncData_closure: {
    "^": "Closure:55;this_0,c_1",
    call$1: [function(resp) {
      ...
      if (resp.get$success() === true) {
        ...
        t2 = t1.ctx;
        t3 = t2.mask;
        t4 = $.get$MaskIcon_INFO();
        t2 = t2.i18n;
        t2 = t2._getMessage$3(t2.locale, "iu.sync.ok", null);
        t3.toString;
        P.print("TESTMASK : mask " + H.S(t4) + "  " + H.S(t2) + "  null");
        t3._getNewFuture$0();
        t2 = this.c_1.future;
        if (t2._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        ...
        t1 = this.this_0;
        t2 = this.c_1;
        if (resp.get$recoverySuccess()) {
          t3 = t1.ctx;
          t4 = t3.mask;
          t5 = $.get$MaskIcon_INFO();
          t6 = $.get$MaskMode_OK();
          t3 = t3.i18n;
          t3 = t3._getMessage$3(t3.locale, "iu.sync.recoveryok", null);
          t4.toString;
          P.print("TESTMASK : mask " + H.S(t5) + "  " + H.S(t3) + "  " + H.S(t6));
          t4._getNewFuture$0().then$1(new A.Initialization_syncData__closure(t2));
        } else {
          t3 = t1.ctx;
          t4 = t3.mask;
          t5 = $.get$MaskIcon_ERROR();
          t6 = $.get$MaskMode_OK();
          t3 = t3.i18n;
          t3 = t3._getMessage$3(t3.locale, "iu.sync.recoveryfailed", null);
          t4.toString;
          P.print("TESTMASK : mask " + H.S(t5) + "  " + H.S(t3) + "  " + H.S(t6));
          t4._getNewFuture$0().then$1(new A.Initialization_syncData__closure0(t2));
        }
      }
      t1.LOG.finest$1("Checking save after sync success: " + H.S(resp));
      t1.ctx.storage.checkSave$1$deep(true);
    }, "call$1", null, 2, 0, null, 103, "call"],
    $isFunction: true
  },
  Initialization_syncData__closure: {
    "^": "Closure:55;c_2",
    call$1: [function(_) {
      var t1 = this.c_2.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(true);
    }, "call$1", null, 2, 0, null, 59, "call"],
  ...
  Initialization_syncData__closure0: {
    "^": "Closure:55;c_3",
    call$1: [function(_) {
  ...
  Initialization_initServerData_closure: {
    "^": "Closure:55;this_0,c_1",
    call$1: [function(sett) {
      var t1, t2, t3;
      t1 = sett.get$lastProfileId() != null && !J.$eq(sett.get$lastProfileId(), sett.get$profile().Id);
      t2 = this.this_0;
      t3 = this.c_1;
      if (t1)
        t2.ctx.storage.clearAll$0().then$1(new A.Initialization_initServerData__closure(t2, t3));
      else
        t2.syncData$0().then$1(new A.Initialization_initServerData__closure0(t2, t3));
    }, "call$1", null, 2, 0, null, 97, "call"],
    $isFunction: true
  },
  Initialization_initServerData__closure: {
    "^": "Closure:55;this_2,c_3",
    call$1: [function(_) {
      var t1 = this.this_2;
      t1.LOG.finest$1("All data cleared! Profile changed.");
      t1.syncData$0().then$1(new A.Initialization_initServerData___closure(t1, this.c_3));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  Initialization_initServerData___closure: {
    "^": "Closure:72;this_4,c_5",
    call$1: [function(ok) {
      var t1;
      this.this_4.LOG.finest$1("All data synced: Result: " + H.S(ok));
      t1 = this.c_5.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(ok);
  ...
  Initialization_initServerData__closure0: {
    "^": "Closure:72;this_6,c_7",
    call$1: [function(ok) {
      var t1;
      this.this_6.LOG.finest$1("All data synced: Result: " + H.S(ok));
      t1 = this.c_7.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(ok);
  ...
  Initialization_initServerUser_closure: {
    "^": "Closure:55;this_0,c_1",
    call$1: [function(sett) {
      var t1, t2, t3, t4;
      t1 = this.this_0;
      ...
      t4 = this.c_1;
      if (t3 !== true)
        t2.server.common.syncMe$0().then$1(new A.Initialization_initServerUser__closure(t1, t4));
      else {
        t1.LOG.finest$1("skipping initialization of server. OFFLINE:" + H.S(t3));
        t1 = t4.future;
        if (t1._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t1._asyncComplete$1(C.InitServerStatus_off);
      }
    }, "call$1", null, 2, 0, null, 97, "call"],
    $isFunction: true
  },
  Initialization_initServerUser__closure: {
    "^": "Closure:55;this_2,c_3",
    call$1: [function(meDO) {
      var ok, t1, t2, t3;
      ok = meDO != null && meDO.get$Id() != null;
      t1 = this.this_2;
      t1.LOG.finest$1("Synchronization of ME Done: Result: " + ok);
      if (ok) {
        t1 = this.c_3.future;
        if (t1._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t1._asyncComplete$1(C.InitServerStatus_ok);
      } else {
        t2 = t1.ctx.offlineMode;
        t1 = t1.LOG;
        t3 = this.c_3;
        if (t2 === true) {
          t1.finest$1("ERR because of offline mode");
          t1 = t3.future;
          if (t1._state !== 0)
            H.throwExpression(P.StateError$("Future already completed"));
          t1._asyncComplete$1(C.InitServerStatus_off);
        } else {
          t1.finest$1("ERR because of 401");
          t1 = t3.future;
          if (t1._state !== 0)
            H.throwExpression(P.StateError$("Future already completed"));
          t1._asyncComplete$1(C.InitServerStatus_e401);
        }
      }
  ...
  InitServerStatus: {
    "^": "Object;value>",
    static: {"^": "InitServerStatus_E401,InitServerStatus_OK,InitServerStatus_ERR,InitServerStatus_OFFLINE"}
  },
  Mask: {
    "^": "Object;"
  },
  MaskIcon: {
    "^": "Object;value>-105,effect<-105",
    static: {"^": "MaskIcon_INFO@-16,MaskIcon_WARN@-16,MaskIcon_ERROR@-16,MaskIcon_LOADING@-16,MaskIcon_QUESTION@-16,MaskIcon_CODE@-16"}
  },
  "+MaskIcon": [106],
  MaskComplete: {
    "^": "Object;value>",
    static: {"^": "MaskComplete_CANCEL,MaskComplete_OK,MaskComplete_YES,MaskComplete_NO,MaskComplete_UNKNOWN"}
  },
  MaskMode: {
    "^": "Object;value>-105",
    static: {"^": "MaskMode_NOBTT@-16,MaskMode_YESNO@-16,MaskMode_OK@-16,MaskMode_OKCANCEL@-16"}
  },
  "+MaskMode": [106],
  MaskMsg: {
    "^": "Object;Code,Type,DefTxt",
    MaskMsg$fromJsonMap$1: function(jsonMap) {
      var t1 = J.getInterceptor$asx(jsonMap);
      this.Code = t1.$index(jsonMap, "DefTxt");
      this.Type = t1.$index(jsonMap, "Type");
      this.DefTxt = t1.$index(jsonMap, "DefTxt");
    },
    static: {"^": "MaskMsg_TYPE_E,MaskMsg_TYPE_W,MaskMsg_TYPE_I", MaskMsg$fromJsonMap: function(jsonMap) {
        var t1 = new A.MaskMsg(null, null, null);
        t1.MaskMsg$fromJsonMap$1(jsonMap);
        return t1;
      }, MaskMsg_transform: function(jsonList) {
        var t1, list, jsonMap, t2, t3;
        if (jsonList != null) {
          t1 = J.getInterceptor(jsonList);
          if (!!t1.$isList)
            if (t1.get$isNotEmpty(jsonList)) {
              list = [];
              for (t1 = t1.get$iterator(jsonList); t1.moveNext$0();) {
                jsonMap = t1.get$current();
                t2 = new A.MaskMsg(null, null, null);
                t3 = J.getInterceptor$asx(jsonMap);
                t2.Code = t3.$index(jsonMap, "DefTxt");
                t2.Type = t3.$index(jsonMap, "Type");
                t2.DefTxt = t3.$index(jsonMap, "DefTxt");
                list.push(t2);
              }
            } else
              list = null;
            ...
            list = [];
            list.push(A.MaskMsg$fromJsonMap(jsonList));
          } else
            list = null;
        } else
          list = null;
  ...
  HttpResp: {
    "^": "Object;request',status*,success@,msg?,respObj@"
  },
  CommonServer: {
    "^": "Server;ctx,LOG",
    syncMe$0: function() {
      ...
      t1 = K.UserDO;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]);
      this.send2Token$1(this.ctx.SERVER + "/api/account/get").then$1(new A.CommonServer_syncMe_closure(this, c));
      return c.future;
    }
  },
  CommonServer_syncMe_closure: {
    "^": "Closure:107;this_1,c_2",
    call$1: [function(resp) {
      var t1, t2, me, meM, profile, map;
      t1 = {};
      t1.me_0 = new K.UserDO(null, null, null, null, null, null, null, null, null, null);
      t1.profile_1 = new K.ProfileDO(null, null, null, null, null, null, null);
      t2 = resp != null && resp.get$success() === true;
      me = t1.me_0;
      if (t2) {
        meM = J.$index$asx(resp.get$respObj(), "user");
        if (meM != null && J.get$isNotEmpty$asx(meM))
          me = K.UserDO_fromJsonMap(meM, me);
        t1.me_0 = me == null ? new K.UserDO(null, null, null, null, null, null, null, null, null, null) : me;
        profile = t1.profile_1;
        map = J.$index$asx(resp.get$respObj(), "profile");
        if (map != null && J.get$isNotEmpty$asx(map))
          profile = K.ProfileDO_fromJsonMap(map, profile);
        t1.profile_1 = profile == null ? new K.ProfileDO(null, null, null, null, null, null, null) : profile;
        this.this_1.ctx.storage.settAction$1(new A.CommonServer_syncMe__closure(t1, resp)).then$1(new A.CommonServer_syncMe__closure0(t1, this.c_2));
      } else {
        t1 = this.c_2.future;
        if (t1._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t1._asyncComplete$1(me);
      }
    }, "call$1", null, 2, 0, null, 103, "call"],
    $isFunction: true
  },
  CommonServer_syncMe__closure: {
    "^": "Closure:55;box_0,resp_3",
    call$1: function(sett) {
      var t1;
      P.print("CHECK ME!");
      t1 = this.box_0;
      sett.set$me(t1.me_0);
      sett.set$profile(t1.profile_1);
      t1 = this.resp_3;
      sett.set$token(J.$index$asx(t1.get$respObj(), "token"));
      sett.set$login(J.$index$asx(t1.get$respObj(), "login"));
    },
    $isFunction: true
  },
  CommonServer_syncMe__closure0: {
    "^": "Closure:55;box_0,c_4",
    call$1: [function(sett) {
      var t1, t2;
      t1 = this.box_0.me_0;
      t2 = this.c_4.future;
  ...
  Server: {
    "^": "Object;",
    _createResponse$1: function(req) {
      var resp, t1, t2, exception;
      resp = new A.HttpResp(null, null, null, null, null);
      t1 = resp;
      t2 = J.getInterceptor$x(t1);
      t2.set$request(t1, req);
      t2.set$status(t1, J.get$status$x(req));
      try {
        t1 = resp;
        t1.set$respObj(C.JsonCodec_null_null.decode$1(J.get$responseText$x(req)));
        t1.set$success(J.$index$asx(resp.get$respObj(), "success"));
        t1.set$msg(A.MaskMsg_transform(J.$index$asx(resp.get$respObj(), "msg")));
      } catch (exception) {
        H.unwrapException(exception);
        this.LOG.warning$1(C.JSString_methods.$add("error parsing response to JSON +\n", J.get$responseText$x(req)));
        resp.set$respObj(J.get$responseText$x(req));
        J.$eq(resp.get$success(), false);
      }

      return resp;
    },
    send2$4$data$method$token: function(url, data, method, token) {
      var t1, completer;
      t1 = A.HttpResp;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]);
      t1 = this.LOG;
      t1.fine$1(method + ":" + H.S(url));
      if (data != null)
        this.LOG.finest$1("    DATA: " + data);
      this.request$5$method$sendData$token$withCredentials(0, url, method, data, token, true).then$2$onError(new A.Server_send2_closure(this, completer), new A.Server_send2_closure0(this, completer));
      return completer.future;
    },
    send2$1: function(url) {
      return this.send2$4$data$method$token(url, null, "GET", null);
    },
    send2$3$data$method: function(url, data, method) {
      return this.send2$4$data$method$token(url, data, method, null);
    },
    send2Token$3$data$method: function(url, data, method) {
      return this.ctx.storage.storeSett.getSett$1$deep(false).then$1(new A.Server_send2Token_closure(this, url, method, data));
    },
    send2Token$1: function(url) {
      return this.send2Token$3$data$method(url, null, "GET");
    },
    request$9$method$mimeType$onProgress$requestHeaders$responseType$sendData$token$withCredentials: function(_, url, method, mimeType, onProgress, requestHeaders, responseType, sendData, token, withCredentials) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.Server_request_closure(completer, xhr)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = C.EventStreamProvider_error0.forTarget$1(xhr);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.Server_request_closure0(completer, xhr)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      if (sendData != null)
        xhr.send(sendData);
      else
        xhr.send();
    ...
    request$5$method$sendData$token$withCredentials: function($receiver, url, method, sendData, token, withCredentials) {
      return this.request$9$method$mimeType$onProgress$requestHeaders$responseType$sendData$token$withCredentials($receiver, url, method, null, null, null, null, sendData, token, withCredentials);
    },
    Server$0: function() {
      var t1 = A.ItinnUtilContext_instance();
      this.ctx = t1;
  ...
  Server_send2_closure: {
    "^": "Closure:109;this_0,completer_1",
    call$1: [function(req) {
      var t1, t2;
      t1 = this.this_0;
      t1.LOG.fine$1("RESPONSE: " + H.S(J.get$responseText$x(req)));
      t1 = t1._createResponse$1(req);
      t2 = this.completer_1.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t2._asyncComplete$1(t1);
  ...
  Server_send2_closure0: {
    "^": "Closure:109;this_2,completer_3",
    call$1: [function(req) {
      var t1, t2, resp;
      t1 = this.this_2;
      t2 = J.getInterceptor$x(req);
      t1.LOG.severe$1("ERROR RESPONSE: " + H.S(t2.get$status(req)) + " " + H.S(t2.get$responseText(req)));
      resp = t1._createResponse$1(req);
      resp.success = false;
      if (J.$eq(t2.get$status(req), 0))
        t1.ctx.offlineMode = true;
      t1 = this.completer_3.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(resp);
    }, "call$1", null, 2, 0, null, 108, "call"],
    $isFunction: true
  },
  Server_send2Token_closure: {
    "^": "Closure:55;this_0,url_1,method_2,data_3",
    call$1: [function(sett) {
      var t1, t2, t3, t4;
      t1 = this.this_0;
      t2 = this.url_1;
      t3 = this.method_2;
      t4 = this.data_3;
      return t1.send2$4$data$method$token(t2, t4, t3, sett.get$token()).then$1(new A.Server_send2Token__closure(t1, t2, t3, t4, sett));
    }, "call$1", null, 2, 0, null, 97, "call"],
    $isFunction: true
  },
  Server_send2Token__closure: {
    "^": "Closure:107;this_4,url_5,method_6,data_7,sett_8",
    call$1: [function(resp) {
      var t1, t2;
      if (J.$eq(J.get$status$x(resp), 401)) {
        t1 = this.sett_8;
        if (t1.get$token() != null && J.get$isNotEmpty$asx(t1.get$token())) {
          t2 = this.this_4;
          t1 = t1.get$token();
          return t2.send2$1(t2.ctx.SERVER + ("/api/account/login?token=" + H.S(t1))).then$1(new A.Server_send2Token___closure(t2, this.url_5, this.method_6, this.data_7, resp));
        } else
          return resp;
      } else
        return resp;
  ...
  Server_send2Token___closure: {
    "^": "Closure:107;this_9,url_10,method_11,data_12,resp_13",
    call$1: [function(loginResp) {
      var t1;
      if (loginResp != null && loginResp.get$success() === true) {
        t1 = this.this_9;
        return t1.ctx.storage.settAction$1(new A.Server_send2Token____closure()).then$1(new A.Server_send2Token____closure0(t1, this.url_10, this.method_11, this.data_12));
      } else
        return this.resp_13;
    }, "call$1", null, 2, 0, null, 110, "call"],
    $isFunction: true
  },
  Server_send2Token____closure: {
    "^": "Closure:55;",
    call$1: function(sett) {
      sett.set$offline(false);
    },
  ...
  Server_send2Token____closure0: {
    "^": "Closure:55;this_14,url_15,method_16,data_17",
    call$1: [function(sett) {
      var t1, t2, t3, t4, t5;
      t1 = this.this_14;
      t1.ctx.offlineMode = false;
      t2 = this.url_15;
      t3 = J.getInterceptor$asx(t2).contains$1(t2, "/api/user/me") || C.JSString_methods.contains$1(t2, "/api/account/get");
      t4 = this.method_16;
      t5 = this.data_17;
      if (t3)
        return t1.send2$3$data$method(t2, t5, t4);
      else
        return t1.ctx.initialization.initServerUser$0().then$1(new A.Server_send2Token_____closure(t1, t2, t4, t5));
    }, "call$1", null, 2, 0, null, 97, "call"],
    $isFunction: true
  },
  Server_send2Token_____closure: {
    "^": "Closure:55;this_18,url_19,method_20,data_21",
    call$1: [function(_) {
      return this.this_18.send2$3$data$method(this.url_19, this.data_21, this.method_20);
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  Server_request_closure1: {
    "^": "Closure:53;xhr_0",
  ...
  Server_request_closure: {
    ...
    call$1: [function(e) {
      ...
      if (t2) {
        ...
        t3.completeError$1(t1);
    }, "call$1", null, 2, 0, null, 1, "call"],
    $isFunction: true
  },
  Server_request_closure0: {
    "^": "Closure:55;completer_3,xhr_4",
    call$1: [function(e) {
      this.completer_3.completeError$1(this.xhr_4);
    }, "call$1", null, 2, 0, null, 1, "call"],
    $isFunction: true
  },
  ServerCtrl: {
    "^": "Object;common,users",
    sync$1$processErrors: function(processErrors) {
      var t1, t2, c;
      t1 = {};
      t2 = A.OperationResponse;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t2)), [t2]);
      t1.success_0 = true;
      t1.offline_1 = false;
      this.users.sync$1$processErrors(processErrors).then$1(new A.ServerCtrl_sync_closure(t1, c, []));
      return c.future;
    }
  },
  ServerCtrl_sync_closure: {
    "^": "Closure:55;box_0,c_1,errors_2",
    call$1: [function(resp) {
      var allResp, t1;
      if (resp.get$success() !== true) {
        this.box_0.success_0 = false;
        if (resp.get$errors() != null)
          C.JSArray_methods.addAll$1(this.errors_2, resp.get$errors());
      }
      if (resp.get$offline() === true)
        this.box_0.offline_1 = true;
      allResp = new A.OperationResponse(false, true, false, null, null);
      t1 = this.box_0;
      allResp.offline = t1.offline_1;
      allResp.success = t1.success_0;
      allResp.errors = this.errors_2;
      t1 = this.c_1.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(allResp);
    }, "call$1", null, 2, 0, null, 103, "call"],
    $isFunction: true
  },
  UsersServer: {
    "^": "MultiSyncServer;onSync,_syncCtrl,stores,syncUrl,ctx,LOG",
    fromJsonMap$2: function(userMap, prefix) {
      if (J.$eq(prefix, "user"))
        return K.UserDO_fromJsonMap(userMap, null);
      else {
        this.LOG.severe$1("!!!Error: Wrong prefix while getting DO from MAP in UsersServer. prefix: " + H.S(prefix));
        return;
      }
    },
    UsersServer$0: function() {
      this.stores = P.LinkedHashMap_LinkedHashMap$_literal(["user", this.ctx.storage.storeUser], null, null);
      this.syncUrl = this.ctx.SERVER + "/api/user/sync";
    },
    static: {UsersServer$: function() {
        var t1 = new A.UsersServer(null, null, null, null, null, null);
        t1.Server$0();
        t1.MultiSyncServer$2$stores$syncUrl(null, null);
        t1.UsersServer$0();
        return t1;
      }}
  },
  MultiSyncReqData: {
    "^": "Object;create,update,$delete,version>",
    delete$1: function($receiver, arg0) {
      return this.$delete.call$1(arg0);
    },
    toJsonMap$0: function() {
      var t1, retMap, t2;
      t1 = {};
      ...
      t1.updateMap_1 = null;
      t1.deleteMap_2 = null;
      retMap = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
      t2 = this.create;
      if (t2 != null && t2._length !== 0)
        t2.forEach$1(0, new A.MultiSyncReqData_toJsonMap_closure(t1, retMap));
      t2 = this.update;
      if (t2 != null && t2._length !== 0)
        t2.forEach$1(0, new A.MultiSyncReqData_toJsonMap_closure0(t1, retMap));
      t2 = this.$delete;
      if (t2 != null && t2._length !== 0)
        t2.forEach$1(0, new A.MultiSyncReqData_toJsonMap_closure1(t1, retMap));
      t1 = this.version;
      if (t1 != null && t1._length !== 0)
        t1.forEach$1(0, new A.MultiSyncReqData_toJsonMap_closure2(retMap));
      return retMap;
    },
    toJson$0: function() {
      return C.JsonCodec_null_null.encode$1(this.toJsonMap$0());
  ...
  MultiSyncReqData_toJsonMap_closure: {
    "^": "Closure:53;box_0,retMap_1",
    call$2: function(prefix, list) {
      var t1 = this.box_0;
      t1.createMap_0 = [];
      J.forEach$1$ax(list, new A.MultiSyncReqData_toJsonMap__closure1(t1));
      this.retMap_1.$indexSet(0, H.S(prefix) + "Create", t1.createMap_0);
    },
    $isFunction: true
  },
  MultiSyncReqData_toJsonMap__closure1: {
    "^": "Closure:55;box_0",
    call$1: [function(item) {
      this.box_0.createMap_0.push(item.toJsonMap$0());
    }, "call$1", null, 2, 0, null, 95, "call"],
    $isFunction: true
  },
  MultiSyncReqData_toJsonMap_closure0: {
    "^": "Closure:53;box_0,retMap_2",
    call$2: function(prefix, list) {
      var t1 = this.box_0;
      t1.updateMap_1 = [];
      J.forEach$1$ax(list, new A.MultiSyncReqData_toJsonMap__closure0(t1));
      this.retMap_2.$indexSet(0, H.S(prefix) + "Update", t1.updateMap_1);
    },
    $isFunction: true
  },
  MultiSyncReqData_toJsonMap__closure0: {
    "^": "Closure:55;box_0",
    call$1: [function(item) {
      this.box_0.updateMap_1.push(item.toJsonMap$0());
    }, "call$1", null, 2, 0, null, 95, "call"],
    $isFunction: true
  },
  MultiSyncReqData_toJsonMap_closure1: {
    "^": "Closure:53;box_0,retMap_3",
    call$2: function(prefix, list) {
      var t1 = this.box_0;
      t1.deleteMap_2 = [];
      J.forEach$1$ax(list, new A.MultiSyncReqData_toJsonMap__closure(t1));
      this.retMap_3.$indexSet(0, H.S(prefix) + "Delete", t1.deleteMap_2);
    },
    $isFunction: true
  },
  MultiSyncReqData_toJsonMap__closure: {
    "^": "Closure:55;box_0",
    call$1: [function(item) {
      this.box_0.deleteMap_2.push(item.toJsonMap$0());
    }, "call$1", null, 2, 0, null, 95, "call"],
    $isFunction: true
  },
  MultiSyncReqData_toJsonMap_closure2: {
    "^": "Closure:53;retMap_4",
    call$2: [function(prefix, version) {
      this.retMap_4.$indexSet(0, H.S(prefix) + "Version", version);
    }, "call$2", null, 4, 0, null, 111, 112, "call"],
    $isFunction: true
  },
  ErrorSyncDesc: {
    "^": "Object;serverItem,localItem<,errorStatus<"
  },
  OperationResponse: {
    "^": "Object;offline@,success@,recoverySuccess@,errors@,recoveryErrors?"
  },
  MultiSyncServer: {
    "^": "Server;",
    sync$2$partOfRecovery$processErrors: function(partOfRecovery, processErrors) {
      var t1, t2, c, versions, prefixes, ctx, f;
      t1 = {};
      this.LOG.finest$1("SYNC - ######################### Start.");
      t2 = A.OperationResponse;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t2)), [t2]);
      versions = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, P.$int);
      t1.toSave_0 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, [P.List, K.GeneralDO]);
      t1.resp_1 = null;
      t1.opResp_2 = null;
      prefixes = [];
      ctx = A.ItinnUtilContext_instance();
      t1.f_3 = P._Future$immediate(null, null);
      if (ctx != null)
        ctx.status$1(0, "Preparing data to send.");
      this.LOG.finest$1("SYNC MAIN: Preparing data to send.");
      this.stores.forEach$1(0, new A.MultiSyncServer_sync_closure(t1, versions, prefixes));
      f = t1.f_3.then$1(new A.MultiSyncServer_sync_closure0(t1, this));
      t1.f_3 = f;
      f = f.then$1(new A.MultiSyncServer_sync_closure1(t1, this, versions, ctx));
      t1.f_3 = f;
      f = f.then$1(new A.MultiSyncServer_sync_closure2(t1, this, processErrors, partOfRecovery, prefixes, ctx));
      t1.f_3 = f;
      f.then$1(new A.MultiSyncServer_sync_closure3(t1, this, c, ctx));
      return c.future;
    },
    sync$1$processErrors: function(processErrors) {
      return this.sync$2$partOfRecovery$processErrors(false, processErrors);
    },
    processSuccess$7: function(changed, allIDs, newVersion, prefix, response, processErrors, skipVersion) {
      var t1, c, f, t2;
      t1 = {};
      t1.response_0 = response;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      f = P._Future$immediate(null, null).then$1(new A.MultiSyncServer_processSuccess_closure(this, changed, prefix));
      if (allIDs != null) {
        t2 = t1.response_0;
        if (t2 != null && t2.get$errors() != null) {
          t2 = t1.response_0.get$errors();
          t2.toString;
          H.IterableMixinWorkaround_forEach(t2, new A.MultiSyncServer_processSuccess_closure0(allIDs));
        }
        f = f.then$1(new A.MultiSyncServer_processSuccess_closure1(this, allIDs, prefix));
      }
      if (processErrors)
        f = f.then$1(new A.MultiSyncServer_processSuccess_closure2(t1, this));
      f.then$1(new A.MultiSyncServer_processSuccess_closure3(this, newVersion, prefix, skipVersion)).then$1(new A.MultiSyncServer_processSuccess_closure4(t1, c));
      return c.future;
    },
    processSuccess$4: function(changed, allIDs, newVersion, prefix) {
      return this.processSuccess$7(changed, allIDs, newVersion, prefix, null, false, false);
    },
    processResponse$5$recovery: function(resp, prefixes, toSave, processErrors, recovery) {
      var t1, t2, c, response, batchSignal;
      t1 = {};
      t2 = A.OperationResponse;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t2)), [t2]);
      if (resp != null)
        if (resp.get$respObj() != null) {
          t2 = resp.get$respObj();
          t2 = typeof t2 === "string" || J.$eq(J.get$status$x(resp), 0);
        } else
          t2 = true;
      else
        t2 = true;
      if (t2) {
        response = new A.OperationResponse(false, true, false, null, null);
        response.offline = J.$eq(J.get$status$x(resp), 0);
        response.success = false;
        t1 = c.future;
        if (t1._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t1._asyncComplete$1(response);
      } else {
        response = new A.OperationResponse(false, true, false, null, null);
        t1.response_1 = response;
        batchSignal = [];
        response.success = resp.get$success();
        t1.f_2 = P._Future$immediate(null, null);
        if (!recovery)
          H.IterableMixinWorkaround_forEach(prefixes, new A.MultiSyncServer_processResponse_closure(this, resp, batchSignal));
        H.IterableMixinWorkaround_forEach(prefixes, new A.MultiSyncServer_processResponse_closure0(t1, this, resp, toSave, processErrors));
        t1.f_2.then$1(new A.MultiSyncServer_processResponse_closure1(t1, this, c, batchSignal));
      }
      return c.future;
    },
    processSyncErrors$1: function(resp) {
      var t1, t2, c, postfix, t3, t4;
      t1 = {};
      t2 = A.OperationResponse;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t2)), [t2]);
      if (resp != null && resp.get$success() !== true && resp.get$errors() != null && resp.get$errors().length !== 0) {
        t2 = this.ctx.i18n;
        t1.errTxt_0 = t2._getMessage$3(t2.locale, "iu.sync.err", null);
        t1.conflict_1 = 0;
        t1.na_2 = 0;
        t1.deleted_3 = 0;
        t1.general_4 = 0;
        t2 = resp.get$errors();
        t2.toString;
        H.IterableMixinWorkaround_forEach(t2, new A.MultiSyncServer_processSyncErrors_closure(t1, this));
        t2 = t1.conflict_1;
        if (t2 > 0) {
          if (t2 > 1)
            if (J.$eq(this.ctx.i18n.locale, "en"))
              postfix = "s";
            else if (J.$eq(this.ctx.i18n.locale, "sk"))
              postfix = t1.conflict_1 < 5 ? "y" : "ov";
            else
              postfix = "";
          else
            postfix = "";
          ...
          t3 = this.ctx.i18n;
          t4 = "" + t1.conflict_1;
          t1.errTxt_0 = J.$add$ns(t2, t3._getMessage$3(t3.locale, "iu.sync.err.desc1", [t4, postfix]));
        }
        t2 = t1.na_2;
        if (t2 > 0) {
          if (t2 > 1)
            if (J.$eq(this.ctx.i18n.locale, "en"))
              ...
              postfix = t1.na_2 < 5 ? "e" : "\u00ed";
            else
              postfix = "";
          else
            postfix = J.$eq(this.ctx.i18n.locale, "sk") ? "a" : "";
          t2 = t1.errTxt_0;
          t3 = this.ctx.i18n;
          t4 = "" + t1.na_2;
          t1.errTxt_0 = J.$add$ns(t2, t3._getMessage$3(t3.locale, "iu.sync.err.desc2", [t4, postfix]));
        }
        t2 = t1.deleted_3;
        if (t2 > 0) {
          t3 = t1.errTxt_0;
          t4 = this.ctx.i18n;
          t2 = "" + t2;
          t1.errTxt_0 = J.$add$ns(t3, t4._getMessage$3(t4.locale, "iu.sync.err.desc3", [t2]));
        }
        t2 = this.ctx.mask;
        t3 = $.get$MaskIcon_ERROR();
        t1 = H.S(t1.errTxt_0) + " ";
        t4 = this.ctx.i18n;
        t4 = t1 + H.S(t4._getMessage$3(t4.locale, "iu.sync.err.recovery.q", null)) + " ";
        t1 = $.get$MaskMode_YESNO();
        t2.toString;
        P.print("TESTMASK : mask " + H.S(t3) + "  " + t4 + "  " + H.S(t1));
        t2._getNewFuture$0().then$1(new A.MultiSyncServer_processSyncErrors_closure0(this, resp, c));
      }
      return c.future;
    },
    recovery$1$processErrors: function(processErrors) {
      var t1, t2, c, f;
      t1 = {};
      this.LOG.finest$1("RECOVERY - ######################### Start.");
      t2 = A.OperationResponse;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t2)), [t2]);
      t1.f_0 = P._Future$immediate(true, null);
      this.stores.forEach$1(0, new A.MultiSyncServer_recovery_closure(t1));
      f = t1.f_0.then$1(new A.MultiSyncServer_recovery_closure0(this, processErrors));
      t1.f_0 = f;
      f.then$1(new A.MultiSyncServer_recovery_closure1(this, c));
      return c.future;
    },
    prepareSyncData$0: function() {
      var c, ret, chF;
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      ret = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, [P.List, K.GeneralDO]);
      chF = [];
      this.stores.forEach$1(0, new A.MultiSyncServer_prepareSyncData_closure(ret, chF));
      P.Future_wait(chF, false).then$1(new A.MultiSyncServer_prepareSyncData_closure0(c, ret));
      return c.future;
    },
    _processChanges$2: function(changed, prefix) {
      var c, f, all, i, t1, result;
      this.LOG.finest$1("SYNC - " + H.S(prefix) + " changes - start.");
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      if (changed != null) {
        f = P._Future$immediate("start", null);
        all = J.get$length$asx(changed);
        if (typeof all !== "number")
          return H.iae(all);
        i = 0;
        for (; i < all; ++i, f = result) {
          t1 = $.Zone__current;
          result = new P._Future(0, t1, null, null, t1.registerUnaryCallback$1(new A.MultiSyncServer__processChanges_closure(this, changed, prefix, all, i)), null, P._registerErrorHandler(null, $.Zone__current), null);
          result.$builtinTypeInfo = [null];
          f._addListener$1(result);
        }
        f.then$1(new A.MultiSyncServer__processChanges_closure0(this, prefix, c));
      } else {
        t1 = c.future;
        if (t1._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
    ...
    _processAllIDS$2: function(allIDs, prefix) {
      var c;
      this.LOG.finest$1("SYNC - " + H.S(prefix) + " allids - start.");
      c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      this.stores.$index(0, prefix).getAll$1$inclDeleted(true).then$1(new A.MultiSyncServer__processAllIDS_closure(this, allIDs, prefix, c));
      return c.future;
    },
    _sync$4: function(url, itemsMap, versions, method) {
      var data = new A.MultiSyncReqData(null, null, null, null);
      J.forEach$1$ax(itemsMap, new A.MultiSyncServer__sync_closure(versions, data));
      return this.send2Token$3$data$method(url, C.JsonCodec_null_null.encode$1(data.toJsonMap$0()), method);
    },
    _sync$3: function(url, itemsMap, versions) {
      return this._sync$4(url, itemsMap, versions, "POST");
    },
    MultiSyncServer$2$stores$syncUrl: function(stores, syncUrl) {
      var t1 = P.StreamController_StreamController(null, null, null, null, false, null);
      this._syncCtrl = t1;
      this.onSync = H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]).asBroadcastStream$0();
    }
  },
  MultiSyncServer_sync_closure: {
    "^": "Closure:53;box_0,versions_1,prefixes_2",
    call$2: function(prefix, store) {
      var t1 = this.box_0;
      t1.f_3 = t1.f_3.then$1(new A.MultiSyncServer_sync__closure2(this.versions_1, this.prefixes_2, prefix, store));
    },
    $isFunction: true
  },
  MultiSyncServer_sync__closure2: {
    "^": "Closure:55;versions_3,prefixes_4,prefix_5,store_6",
    call$1: [function(_) {
      return this.store_6.getVersion$1$deep(true).then$1(new A.MultiSyncServer_sync___closure(this.versions_3, this.prefixes_4, this.prefix_5));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_sync___closure: {
    "^": "Closure:55;versions_7,prefixes_8,prefix_9",
    call$1: [function(version) {
      var t1 = this.prefix_9;
      this.versions_7.$indexSet(0, t1, version);
      this.prefixes_8.push(t1);
    }, "call$1", null, 2, 0, null, 112, "call"],
    $isFunction: true
  },
  MultiSyncServer_sync_closure0: {
    "^": "Closure:55;box_0,this_10",
    call$1: [function(_) {
      return this.this_10.prepareSyncData$0().then$1(new A.MultiSyncServer_sync__closure1(this.box_0));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_sync__closure1: {
    "^": "Closure:55;box_0",
    call$1: [function(val) {
      this.box_0.toSave_0 = val;
    }, "call$1", null, 2, 0, null, 113, "call"],
    $isFunction: true
  },
  MultiSyncServer_sync_closure1: {
    "^": "Closure:55;box_0,this_11,versions_12,ctx_13",
    call$1: [function(_) {
      var t1, t2;
      t1 = this.ctx_13;
      if (t1 != null)
        t1.status$1(0, "Sending data.");
      t1 = this.this_11;
      t1.LOG.finest$1("SYNC MAIN: Sending data.");
      t2 = this.box_0;
      return t1._sync$3(t1.syncUrl, t2.toSave_0, this.versions_12).then$1(new A.MultiSyncServer_sync__closure0(t2));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_sync__closure0: {
    "^": "Closure:55;box_0",
    call$1: [function(r) {
      this.box_0.resp_1 = r;
  ...
  MultiSyncServer_sync_closure2: {
    "^": "Closure:55;box_0,this_14,processErrors_15,partOfRecovery_16,prefixes_17,ctx_18",
    call$1: [function(_) {
      var t1, t2;
      t1 = this.ctx_18;
      if (t1 != null)
        t1.status$1(0, "Received response.");
      t1 = this.this_14;
      t1.LOG.finest$1("SYNC MAIN: Received response.");
      t2 = this.box_0;
      return t1.processResponse$5$recovery(t2.resp_1, this.prefixes_17, t2.toSave_0, this.processErrors_15, this.partOfRecovery_16).then$1(new A.MultiSyncServer_sync__closure(t2));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_sync__closure: {
    "^": "Closure:55;box_0",
    call$1: [function(r) {
      this.box_0.opResp_2 = r;
    }, "call$1", null, 2, 0, null, 114, "call"],
    $isFunction: true
  },
  MultiSyncServer_sync_closure3: {
    "^": "Closure:55;box_0,this_19,c_20,ctx_21",
    call$1: [function(_) {
      var t1, t2, t3, t4;
      t1 = this.ctx_21;
      if (t1 != null)
        t1.status$1(0, "Response processed.");
      t1 = this.this_19;
      t1.LOG.finest$1("SYNC MAIN: Response processed.");
      t2 = this.box_0;
      t3 = t2.opResp_2;
      t4 = this.c_20.future;
      if (t4._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t4._asyncComplete$1(t3);
      t3 = t1._syncCtrl;
      t2 = t2.opResp_2;
      if (t3._state >= 4)
        H.throwExpression(t3._badEventState$0());
      ...
      if ((t4 & 1) !== 0)
        ...
        t3._ensurePendingEvents$0().add$1(0, H.setRuntimeTypeInfo(new P._DelayedData(t2, null), [H.getRuntimeTypeArgument(t3, "_StreamController", 0)]));
      t1.LOG.finest$1("SYNC - ######################### End.");
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_processSuccess_closure: {
    "^": "Closure:55;this_1,changed_2,prefix_3",
    call$1: [function(_) {
      return this.this_1._processChanges$2(this.changed_2, this.prefix_3);
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_processSuccess_closure0: {
    "^": "Closure:55;allIDs_4",
    call$1: function(err) {
      var t1, t2;
      t1 = this.allIDs_4;
      t2 = J.getInterceptor$asx(t1);
      if (t2.contains$1(t1, err.get$localItem().get$Id()) !== true)
        t2.add$1(t1, err.get$localItem().get$Id());
    },
    $isFunction: true
  },
  MultiSyncServer_processSuccess_closure1: {
    "^": "Closure:55;this_5,allIDs_6,prefix_7",
    call$1: [function(_) {
      return this.this_5._processAllIDS$2(this.allIDs_6, this.prefix_7);
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_processSuccess_closure2: {
    "^": "Closure:55;box_0,this_8",
    call$1: [function(_) {
      var t1 = this.box_0;
      return this.this_8.processSyncErrors$1(t1.response_0).then$1(new A.MultiSyncServer_processSuccess__closure(t1));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_processSuccess__closure: {
    "^": "Closure:55;box_0",
    call$1: [function(recoveryResp) {
      this.box_0.response_0 = recoveryResp;
    }, "call$1", null, 2, 0, null, 115, "call"],
    $isFunction: true
  },
  MultiSyncServer_processSuccess_closure3: {
    "^": "Closure:55;this_9,newVersion_10,prefix_11,skipVersion_12",
    call$1: [function(_) {
      var t1, t2;
      t1 = this.this_9;
      t2 = this.prefix_11;
      t1.stores.$index(0, t2).isSync$1$deep(true);
      if (!this.skipVersion_12) {
        t1 = t1.stores.$index(0, t2);
        t2 = this.newVersion_10;
        t1.version = t2 != null ? H.Primitives_parseInt(H.S(t2), 10, null) : 0;
      }
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_processSuccess_closure4: {
    "^": "Closure:55;box_0,c_13",
    call$1: [function(_) {
      var t1, t2;
      t1 = this.box_0.response_0;
      t2 = this.c_13.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t2._asyncComplete$1(t1);
  ...
  MultiSyncServer_processResponse_closure: {
    "^": "Closure:55;this_2,resp_3,batchSignal_4",
    call$1: function(prefix) {
      var changed, t1, t2;
      changed = J.$index$asx(this.resp_3.get$respObj(), H.S(prefix) + "Changed");
      if (changed != null && J.$gt$n(J.get$length$asx(changed), 10)) {
        this.batchSignal_4.push(prefix);
        t1 = this.this_2.stores.$index(0, prefix).batchStartCtrl;
        if (t1._state >= 4)
          H.throwExpression(t1._badEventState$0());
        t2 = t1._state;
        if ((t2 & 1) !== 0)
  ...
  MultiSyncServer_processResponse_closure0: {
    "^": "Closure:55;box_1,this_5,resp_6,toSave_7,processErrors_8",
    call$1: function(prefix) {
      var t1, changed, allIDs, newVersion, statusMap, t2;
      t1 = this.resp_6;
      changed = J.$index$asx(t1.get$respObj(), H.S(prefix) + "Changed");
      allIDs = J.$index$asx(t1.get$respObj(), H.S(prefix) + "AllIDs");
      newVersion = J.$index$asx(t1.get$respObj(), H.S(prefix) + "Version");
      statusMap = J.$index$asx(t1.get$respObj(), H.S(prefix) + "Status");
      if (t1.get$success() === true) {
        t1 = this.box_1;
        t1.f_2 = t1.f_2.then$1(new A.MultiSyncServer_processResponse__closure0(this.this_5, prefix, changed, allIDs, newVersion));
      } else {
        t1 = this.box_1;
        if (t1.response_1.get$errors() == null)
          t1.response_1.set$errors([]);
        t2 = this.toSave_7;
        if (t2 != null && J.$index$asx(t2, prefix) != null)
          J.forEach$1$ax(J.$index$asx(t2, prefix), new A.MultiSyncServer_processResponse__closure1(t1, changed, statusMap));
        t1.f_2 = t1.f_2.then$1(new A.MultiSyncServer_processResponse__closure2(t1, this.this_5, this.processErrors_8, prefix, changed, allIDs, newVersion));
      }
    },
    $isFunction: true
  },
  MultiSyncServer_processResponse__closure0: {
    "^": "Closure:55;this_9,prefix_10,changed_11,allIDs_12,newVersion_13",
    call$1: [function(_) {
      return this.this_9.processSuccess$4(this.changed_11, this.allIDs_12, this.newVersion_13, this.prefix_10);
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_processResponse__closure1: {
    "^": "Closure:55;box_1,changed_14,statusMap_15",
    call$1: [function(item) {
      var t1, t2, t3, err;
      t1 = {};
      t2 = this.statusMap_15;
      if (t2 != null) {
        t3 = J.getInterceptor$asx(t2);
        t3 = t3.$index(t2, item.get$SyncId()) != null && J.startsWith$1$s(t3.$index(t2, item.get$SyncId()), "E");
      } else
        t3 = false;
      if (t3) {
        err = new A.ErrorSyncDesc(null, null, null);
        err.errorStatus = J.$index$asx(t2, item.get$SyncId());
        err.localItem = item;
        this.box_1.response_1.get$errors().push(err);
        t2 = this.changed_14;
        if (t2 != null) {
          t1.found_0 = null;
          t3 = J.getInterceptor$ax(t2);
          t3.forEach$1(t2, new A.MultiSyncServer_processResponse___closure0(t1, item, err));
          t1 = t1.found_0;
          if (t1 != null)
            t3.remove$1(t2, t1);
        }
  ...
  MultiSyncServer_processResponse___closure0: {
    "^": "Closure:55;box_0,item_16,err_17",
    call$1: [function(itemMap) {
      var t1, t2;
      t1 = this.item_16;
      t2 = J.getInterceptor$asx(itemMap);
      if (J.$eq(t1.get$Id(), t2.$index(itemMap, "Id")) || J.$eq(t1.get$SyncId(), t2.$index(itemMap, "SyncId"))) {
        this.err_17.serverItem = itemMap;
        this.box_0.found_0 = itemMap;
      }
    }, "call$1", null, 2, 0, null, 116, "call"],
    $isFunction: true
  },
  MultiSyncServer_processResponse__closure2: {
    "^": "Closure:55;box_1,this_18,processErrors_19,prefix_20,changed_21,allIDs_22,newVersion_23",
    call$1: [function(_) {
      var t1 = this.box_1;
      return this.this_18.processSuccess$7(this.changed_21, this.allIDs_22, this.newVersion_23, this.prefix_20, t1.response_1, this.processErrors_19, true).then$1(new A.MultiSyncServer_processResponse___closure(t1));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_processResponse___closure: {
    "^": "Closure:55;box_1",
    call$1: [function(resp) {
      this.box_1.response_1 = resp;
    }, "call$1", null, 2, 0, null, 103, "call"],
    $isFunction: true
  },
  MultiSyncServer_processResponse_closure1: {
    "^": "Closure:55;box_1,this_24,c_25,batchSignal_26",
    call$1: [function(_) {
      var t1, t2, t3;
      t1 = this.box_1;
      t2 = t1.response_1;
      ...
      t3._asyncComplete$1(t2);
      t2 = this.this_24;
      H.IterableMixinWorkaround_forEach(this.batchSignal_26, new A.MultiSyncServer_processResponse__closure(t2));
      t2 = t2._syncCtrl;
      t1 = t1.response_1;
      if (t2._state >= 4)
        H.throwExpression(t2._badEventState$0());
  ...
  MultiSyncServer_processResponse__closure: {
    "^": "Closure:55;this_27",
    call$1: function(prefix) {
      var t1, t2;
      t1 = this.this_27.stores.$index(0, prefix).batchStartCtrl;
      if (t1._state >= 4)
        H.throwExpression(t1._badEventState$0());
      t2 = t1._state;
      if ((t2 & 1) !== 0)
  ...
  MultiSyncServer_processSyncErrors_closure: {
    "^": "Closure:55;box_0,this_1",
    call$1: function(err) {
      var t1, t2, t3, t4;
      if (J.$eq(err.get$errorStatus(), "EC"))
        ++this.box_0.conflict_1;
      else if (J.$eq(err.get$errorStatus(), "ENA"))
        ++this.box_0.na_2;
      else {
        t1 = this.box_0;
        if (J.$eq(err.get$errorStatus(), "ED"))
          ++t1.deleted_3;
        else {
          ++t1.general_4;
          t2 = t1.errTxt_0;
          t3 = this.this_1.ctx.i18n;
          t4 = err.get$errorStatus();
          t1.errTxt_0 = J.$add$ns(t2, t3._getMessage$3(t3.locale, "iu.sync.err.descGeneral", [t4]));
        }
      }
    },
    $isFunction: true
  },
  MultiSyncServer_processSyncErrors_closure0: {
    "^": "Closure:55;this_2,resp_3,c_4",
    call$1: [function(resp3) {
      var t1, t2, t3, t4, t5;
      t1 = this.resp_3;
      t2 = this.c_4;
      if (J.$eq(resp3, $.get$MaskComplete_YES())) {
        t3 = this.this_2;
        t4 = t3.ctx;
        t5 = t4.mask;
        t4 = t4.i18n;
        t4 = t4._getMessage$3(t4.locale, "iu.sync.recovery.progress", null);
        t5.toString;
        P.print("TESTMASK : mask null  " + H.S(t4) + "  null");
        t5._getNewFuture$0();
        t3.recovery$1$processErrors(false).then$1(new A.MultiSyncServer_processSyncErrors__closure(t3, t1, t2));
      } else {
        t1.set$recoverySuccess(false);
        t2 = t2.future;
        if (t2._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t2._asyncComplete$1(t1);
  ...
  MultiSyncServer_processSyncErrors__closure: {
    "^": "Closure:119;this_5,resp_6,c_7",
    call$1: [function(resp2) {
      var t1, t2, t3, t4, t5, t6;
      t1 = this.this_5;
      t2 = this.resp_6;
      t3 = this.c_7;
      if (resp2.get$success() === true) {
        t4 = t1.ctx;
        t5 = t4.mask;
        t6 = $.get$MaskIcon_INFO();
        t4 = t4.i18n;
        t4 = t4._getMessage$3(t4.locale, "iu.sync.recovery.done", null);
        t5.toString;
        P.print("TESTMASK : mask " + H.S(t6) + "  " + H.S(t4) + "  null");
        t5._getNewFuture$0();
        t1 = t1.ctx.mask;
        t1.toString;
        P.print("TESTMASK : umMaskDefer 500 null");
        t1._all_tests$_complete$1(null).then$1(new A.MultiSyncServer_processSyncErrors___closure(t2, t3, resp2));
      } else {
        t1 = t1.ctx;
        t4 = t1.mask;
        t5 = $.get$MaskIcon_ERROR();
        t1 = t1.i18n;
        t1 = t1._getMessage$3(t1.locale, "iu.sync.recovery.failed", null);
        t6 = $.get$MaskMode_OK();
        t4.toString;
        P.print("TESTMASK : mask " + H.S(t5) + "  " + H.S(t1) + "  " + H.S(t6));
        t4._getNewFuture$0().then$1(new A.MultiSyncServer_processSyncErrors___closure0(t2, t3, resp2));
      }
    }, "call$1", null, 2, 0, null, 118, "call"],
    $isFunction: true
  },
  MultiSyncServer_processSyncErrors___closure: {
    "^": "Closure:55;resp_8,c_9,resp2_10",
    call$1: [function(_) {
      var t1, t2;
      t1 = this.resp_8;
      t1.set$recoverySuccess(true);
      t1.set$recoveryErrors(this.resp2_10.get$errors());
      t2 = this.c_9.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t2._asyncComplete$1(t1);
  ...
  MultiSyncServer_processSyncErrors___closure0: {
    "^": "Closure:55;resp_11,c_12,resp2_13",
    call$1: [function(_) {
      var t1, t2;
      t1 = this.resp_11;
      t1.set$recoverySuccess(false);
      t1.set$recoveryErrors(this.resp2_13.get$errors());
      t2 = this.c_12.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t2._asyncComplete$1(t1);
  ...
  MultiSyncServer_recovery_closure: {
    "^": "Closure:53;box_0",
    call$2: function(prefix, store) {
      var t1 = this.box_0;
      t1.f_0 = t1.f_0.then$1(new A.MultiSyncServer_recovery__closure1(store));
    },
    $isFunction: true
  },
  MultiSyncServer_recovery__closure1: {
    "^": "Closure:55;store_1",
    call$1: [function(ok) {
      var t1, t2, t3;
      if (ok !== true)
        ...
        if ((t3 & 1) !== 0)
          ...
          t2._ensurePendingEvents$0().add$1(0, H.setRuntimeTypeInfo(new P._DelayedData(true, null), [H.getRuntimeTypeArgument(t2, "_StreamController", 0)]));
        return J.clear$0$ax(t1);
      }
    }, "call$1", null, 2, 0, null, 58, "call"],
    $isFunction: true
  },
  MultiSyncServer_recovery_closure0: {
    "^": "Closure:55;this_2,processErrors_3",
    call$1: [function(ok) {
      var t1, resp;
      if (ok === true) {
        t1 = this.this_2;
        return t1.sync$2$partOfRecovery$processErrors(true, this.processErrors_3).then$1(new A.MultiSyncServer_recovery__closure0(t1));
      } else {
        resp = new A.OperationResponse(false, true, false, null, null);
        resp.success = false;
  ...
  MultiSyncServer_recovery__closure0: {
    "^": "Closure:55;this_4",
    call$1: [function(_) {
      this.this_4.LOG.finest$1("RECOVERY - ######################### End.");
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer_recovery_closure1: {
    "^": "Closure:55;this_5,c_6",
    call$1: [function(resp) {
      var t1;
      this.this_5.stores.forEach$1(0, new A.MultiSyncServer_recovery__closure());
      t1 = this.c_6.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(resp);
  ...
  MultiSyncServer_recovery__closure: {
    "^": "Closure:53;",
    call$2: function(prefix, store) {
      var t1, t2;
      t1 = store.get$batchEndCtrl();
      if (t1._state >= 4)
        H.throwExpression(t1._badEventState$0());
      t2 = t1._state;
      if ((t2 & 1) !== 0)
  ...
  MultiSyncServer_prepareSyncData_closure: {
    "^": "Closure:53;ret_0,chF_1",
    call$2: function(prefix, store) {
      this.chF_1.push(store.getAll$1$inclDeleted(true).then$1(new A.MultiSyncServer_prepareSyncData__closure(this.ret_0, prefix)));
    },
    $isFunction: true
  },
  MultiSyncServer_prepareSyncData__closure: {
    "^": "Closure:55;ret_2,prefix_3",
    call$1: [function(items) {
      var toSave = [];
      if (items != null && J.get$isNotEmpty$asx(items))
        J.forEach$1$ax(items, new A.MultiSyncServer_prepareSyncData___closure(toSave));
      this.ret_2.$indexSet(0, this.prefix_3, toSave);
    }, "call$1", null, 2, 0, null, 120, "call"],
    $isFunction: true
  },
  MultiSyncServer_prepareSyncData___closure: {
    "^": "Closure:55;toSave_4",
    call$1: [function(item) {
      if (!J.$eq(item.get$Sync(), true))
        this.toSave_4.push(item);
    }, "call$1", null, 2, 0, null, 95, "call"],
    $isFunction: true
  },
  MultiSyncServer_prepareSyncData_closure0: {
    "^": "Closure:55;c_5,ret_6",
    call$1: [function(_) {
      var t1 = this.c_5.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(this.ret_6);
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer__processChanges_closure: {
    "^": "Closure:55;this_0,changed_1,prefix_2,all_3,idx_4",
    call$1: [function(_) {
      var t1, t2, t3, t4, t5, id, serverItem;
      t1 = this.this_0;
      t2 = this.prefix_2;
      t3 = this.idx_4;
      t4 = this.all_3;
      t1.LOG.finest$1("SYNC - " + H.S(t2) + " changes merging - " + (t3 + 1) + " from " + H.S(t4) + ".");
      t5 = t1.ctx;
      if (t5 != null)
        t5.status$1(0, "Processing record " + t3 + " / " + H.S(t4));
      t4 = this.changed_1;
      t5 = J.getInterceptor$asx(t4);
      id = J.$index$asx(t5.$index(t4, t3), "SyncId") != null ? J.$index$asx(t5.$index(t4, t3), "SyncId") : J.$index$asx(t5.$index(t4, t3), "Id");
      H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      serverItem = t1.fromJsonMap$2(t5.$index(t4, t3), t2);
      return t1.stores.$index(0, t2).merge$2$item$oldId(serverItem, id);
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  MultiSyncServer__processChanges_closure0: {
    "^": "Closure:55;this_5,prefix_6,c_7",
    call$1: [function(_) {
      var t1;
      this.this_5.LOG.finest$1("SYNC - " + H.S(this.prefix_6) + " changes - done.");
      t1 = this.c_7.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(null);
  ...
  MultiSyncServer__processAllIDS_closure: {
    "^": "Closure:55;this_0,allIDs_1,prefix_2,c_3",
    call$1: [function(items) {
      var childFutures, itemsToRemove, t1, t2, t3, t4;
      childFutures = [];
      if (items != null) {
        itemsToRemove = [];
        t1 = this.allIDs_1;
        J.forEach$1$ax(items, new A.MultiSyncServer__processAllIDS__closure(t1, itemsToRemove));
        t2 = this.this_0;
        t3 = this.prefix_2;
        H.IterableMixinWorkaround_forEach(itemsToRemove, new A.MultiSyncServer__processAllIDS__closure0(t2, t3, childFutures));
        t4 = J.getInterceptor$asx(t1);
        if (t4.get$isNotEmpty(t1))
          t4.forEach$1(t1, new A.MultiSyncServer__processAllIDS__closure1(t2, t3));
      }
      P.Future_wait(childFutures, false).then$1(new A.MultiSyncServer__processAllIDS__closure2(this.this_0, this.prefix_2, this.c_3));
    }, "call$1", null, 2, 0, null, 120, "call"],
    $isFunction: true
  },
  MultiSyncServer__processAllIDS__closure: {
    "^": "Closure:55;allIDs_4,itemsToRemove_5",
    call$1: [function(item) {
      var t1, t2;
      t1 = this.allIDs_4;
      t2 = J.getInterceptor$asx(t1);
      if (t2.contains$1(t1, item.get$Id()) !== true)
        this.itemsToRemove_5.push(item);
      else
        t2.remove$1(t1, item.get$Id());
    }, "call$1", null, 2, 0, null, 95, "call"],
    $isFunction: true
  },
  MultiSyncServer__processAllIDS__closure0: {
    "^": "Closure:55;this_6,prefix_7,childFutures_8",
    call$1: function(item) {
      this.childFutures_8.push(this.this_6.stores.$index(0, this.prefix_7).remove$2$sync(0, item, true));
    },
    $isFunction: true
  },
  MultiSyncServer__processAllIDS__closure1: {
    "^": "Closure:55;this_9,prefix_10",
    call$1: [function(id) {
      var t1 = this.this_9;
      t1.LOG.finest$1("SYNC - " + H.S(this.prefix_10) + " allids - PROBLEM - ID:" + H.S(id) + " - syncUrl: " + H.S(t1.syncUrl));
    }, "call$1", null, 2, 0, null, 89, "call"],
    $isFunction: true
  },
  MultiSyncServer__processAllIDS__closure2: {
    "^": "Closure:55;this_11,prefix_12,c_13",
    call$1: [function(_) {
      var t1;
      this.this_11.LOG.finest$1("SYNC - " + H.S(this.prefix_12) + " allids - done.");
      t1 = this.c_13.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(null);
  ...
  MultiSyncServer__sync_closure: {
    "^": "Closure:121;versions_0,data_1",
    call$2: [function(prefix, items) {
      if (items != null && J.get$isNotEmpty$asx(items))
        J.forEach$1$ax(items, new A.MultiSyncServer__sync__closure(this.data_1, prefix));
      this.data_1.version = this.versions_0;
    }, "call$2", null, 4, 0, null, 111, 120, "call"],
    $isFunction: true
  },
  MultiSyncServer__sync__closure: {
    "^": "Closure:55;data_2,prefix_3",
    call$1: [function(item) {
      var t1, t2, t3;
      item.set$SyncId(item.get$Id());
      if (J.$eq(item.get$Sync(), "create")) {
        t1 = this.data_2;
        t2 = t1.create;
        if (t2 == null) {
          t2 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, P.List);
          t1.create = t2;
        }
        t3 = this.prefix_3;
        if (t2.$index(0, t3) == null)
          t1.create.$indexSet(0, t3, []);
        item.set$SyncId(item.get$Id());
        J.add$1$ax(t1.create.$index(0, t3), item);
      }
      if (J.$eq(item.get$Sync(), "update")) {
        t1 = this.data_2;
        t2 = t1.update;
        if (t2 == null) {
          t2 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, P.List);
        ...
        t3 = this.prefix_3;
        if (t2.$index(0, t3) == null)
          t1.update.$indexSet(0, t3, []);
        J.add$1$ax(t1.update.$index(0, t3), item);
      }
      if (J.$eq(item.get$Sync(), "delete")) {
        t1 = this.data_2;
        t2 = t1.$delete;
        if (t2 == null) {
          t2 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, P.List);
        ...
        t3 = this.prefix_3;
        if (t2.$index(0, t3) == null)
          t1.$delete.$indexSet(0, t3, []);
        J.add$1$ax(t1.$delete.$index(0, t3), item);
      }
    }, "call$1", null, 2, 0, null, 95, "call"],
    $isFunction: true
  },
  Util_hideFull_closure: {
    "^": "Closure:55;el_0,c_1",
    call$1: function($event) {
      C.JSNull_methods.get$classes(this.el_0).contains$1(0, "off");
    },
    $isFunction: true
  }
}],
["lawndart_ext", "package:lawndart_ext/lawndart_ext.dart", , Z, {
  "^": "",
  Store_Store: function(dbName, storeName, indexes, options, $V) {
    if (!!(window.indexedDB || window.webkitIndexedDB || window.mozIndexedDB))
      return H.setRuntimeTypeInfo(new Z.IndexedDbStore(dbName, storeName, indexes, false), [null]);
    else if (!!window.openDatabase)
      return H.setRuntimeTypeInfo(new Z.WebSqlStore(dbName, storeName, 4194304, indexes, P.LinkedHashMap_LinkedHashMap$_empty(null, null), "id, value", "?, ?", [], false), [null]);
    else
      return H.setRuntimeTypeInfo(new Z.LocalStorageStore(null, false), [null]);
  },
  IndexDesc: {
    "^": "Object;name>,keyPath>,unique>,multi<,websqlType<"
  },
  Store: {
    "^": "Object;",
    keys$0: [function(_) {
      ...
      return this._lawndart_ext$_keys$0();
    }, "call$0", "get$keys", 0, 0, 122],
    save$2: function(_, obj, key) {
      if (!this._isOpen)
        H.throwExpression(P.StateError$(this.get$runtimeType(this).toString$0(0) + " is not open"));
      if (key == null)
        throw H.wrapException(P.ArgumentError$("key must not be null"));
  ...
  _MapStore: {
    ...
    _lawndart_ext$_keys$0: function() {
    ...
    _all$0: function() {
      return P.Stream_Stream$fromIterable(J.get$values$x(this.storage), null);
    },
    _removeByKey$1: function(key) {
      J.remove$1$ax(this.storage, key);
      return P._Future$immediate(true, null);
    },
    _nuke$0: function() {
      this.storage.clear();
  ...
  IndexedDbStore: {
    ...
    open$1$force: function(_, force) {
      ...
      t1 = this.dbName;
      if ($.get$IndexedDbStore__databases().$index(0, t1) != null && force) {
        J.close$0$x($.get$IndexedDbStore__databases().$index(0, t1));
        $.get$IndexedDbStore__databases().$indexSet(0, t1, null);
      }
      if ($.get$IndexedDbStore__databases().$index(0, t1) != null)
        return this._initIdb$1($.get$IndexedDbStore__databases().$index(0, t1)).then$1(new Z.IndexedDbStore_open_closure(this));
      else {
        t2 = window;
        return J.open$1$x(t2.indexedDB || t2.webkitIndexedDB || t2.mozIndexedDB, t1).then$1(new Z.IndexedDbStore_open_closure0()).then$1(this.get$_initIdb()).then$1(new Z.IndexedDbStore_open_closure1(this));
      }
    },
    open$0: function($receiver) {
      return this.open$1$force($receiver, false);
    },
    _checkIndexes$1: function(db) {
      var t1, t2, store, idx;
      t1 = this.indexes;
      if (t1 == null || t1.length === 0)
        return true;
      t2 = this.storeName;
      store = J.objectStore$1$x(J.transaction$2$x(db, t2, "readonly"), t2);
      for (t1 = H.setRuntimeTypeInfo(new H.ListIterator(t1, t1.length, 0, null), [H.getTypeArgumentByIndex(t1, 0)]), t2 = J.getInterceptor$x(store); t1.moveNext$0();) {
        idx = t1._current;
        if (t2.get$indexNames(store).contains(J.get$name$x(idx)) !== true)
          return false;
      }
      return true;
    },
    _initIdb$1: [function(db) {
      ...
      if (t1.get$objectStoreNames(db).contains(this.storeName) !== true || !this._checkIndexes$1(db)) {
        t1.close$0(db);
        t2 = window;
        return J.open$3$onUpgradeNeeded$version$x(t2.indexedDB || t2.webkitIndexedDB || t2.mozIndexedDB, this.dbName, new Z.IndexedDbStore__initIdb_closure(this), J.$add$ns(H.Primitives_parseInt(H.S(t1.get$version(db)), 10, null), 1));
      } else
        return P._Future$immediate(db, null);
    }, "call$1", "get$_initIdb", 2, 0, 123, 124],
    _removeByKey$1: function(key) {
      return this._doCommand$1(new Z.IndexedDbStore__removeByKey_closure(key));
    },
    _save$2: function(obj, key) {
      return this._doCommand$1(new Z.IndexedDbStore__save_closure(obj, key));
    },
    _getByKey$1: function(key) {
      return this._doCommand$2(new Z.IndexedDbStore__getByKey_closure(key), "readonly");
    },
    _nuke$0: function() {
      return this._doCommand$1(new Z.IndexedDbStore__nuke_closure());
    },
    _doCommand$2: function(requestCommand, txnMode) {
      ...
      return t2.get$completed(trans).then$1(new Z.IndexedDbStore__doCommand_closure(future));
    },
    ...
    _doGetAll$1: function(onCursor) {
      ...
      t1 = this.storeName;
      J.openCursor$1$autoAdvance$x(J.objectStore$1$x(J.transaction$2$x($.get$IndexedDbStore__databases().$index(0, this.dbName), t1, "readonly"), t1), true).listen$3$onDone$onError(new Z.IndexedDbStore__doGetAll_closure(onCursor, controller), new Z.IndexedDbStore__doGetAll_closure0(controller), new Z.IndexedDbStore__doGetAll_closure1(controller));
      return H.setRuntimeTypeInfo(new P._ControllerStream(controller), [null]);
    },
    _all$0: function() {
      return this._doGetAll$1(new Z.IndexedDbStore__all_closure());
    },
    _lawndart_ext$_keys$0: function() {
      return this._doGetAll$1(new Z.IndexedDbStore__keys_closure());
    },
  ...
  IndexedDbStore__initIdb_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(e) {
      var db, t1, t2, t3, os, index, t4, t5, options;
      db = J.get$result$x(J.get$target$x(e));
      t1 = J.getInterceptor$x(db);
      t2 = this.this_0;
      t3 = t2.storeName;
      if (t1.get$objectStoreNames(db).contains(t3) === true)
        t1.deleteObjectStore$1(db, t3);
      os = t1.createObjectStore$1(db, t3);
      t1 = t2.indexes;
      if (t1 != null)
        for (t1 = H.setRuntimeTypeInfo(new H.ListIterator(t1, t1.length, 0, null), [H.getTypeArgumentByIndex(t1, 0)]); t1.moveNext$0();) {
          index = t1._current;
          t2 = J.getInterceptor$x(index);
          if (os.indexNames.contains(t2.get$name(index)) !== true) {
            ...
            if (t2 != null)
              options.$indexSet(0, "unique", t2);
            options.$indexSet(0, "multiEntry", t5);
            C.ObjectStore_methods._createIndex$3(os, t3, t4, options);
          }
        }
    }, "call$1", null, 2, 0, null, 1, "call"],
    $isFunction: true
  },
  IndexedDbStore__removeByKey_closure: {
    "^": "Closure:125;key_0",
    call$1: function(store) {
      return J.delete$1$x(store, this.key_0);
    },
    $isFunction: true
  },
  IndexedDbStore__save_closure: {
    "^": "Closure:125;obj_0,key_1",
    call$1: function(store) {
  ...
  IndexedDbStore__doGetAll_closure: {
    "^": "Closure:55;onCursor_0,controller_1",
  ...
  WebSqlStore: {
    "^": "Store;dbName,storeName,estimatedSize,indexes,_indexMap,_updateCols,_updateQ,_idxPaths,_isOpen",
    open$1$force: function(_, force) {
      var completer, t1;
      ...
      if ($.WebSqlStore__db == null) {
        t1 = this.dbName;
        $.WebSqlStore__db = window.openDatabase(t1, "1", t1, 4096);
      }
    ...
    _initDb$1: function(completer) {
      var t1, t2;
      t1 = {};
      t1.sql_0 = "CREATE TABLE IF NOT EXISTS " + H.S(this.storeName) + " (id NVARCHAR(32) UNIQUE PRIMARY KEY, value TEXT";
      t2 = this.indexes;
      if (t2 != null && t2.length !== 0) {
        t2.toString;
        H.IterableMixinWorkaround_forEach(t2, new Z.WebSqlStore__initDb_closure(t1, this));
      }
      t1.sql_0 += ")";
      J.transaction$2$x($.WebSqlStore__db, new Z.WebSqlStore__initDb_closure0(t1, this, completer), new Z.WebSqlStore__initDb_closure1(completer));
    },
    _lawndart_ext$_keys$0: function() {
      var sql, controller;
      sql = "SELECT id FROM " + H.S(this.storeName);
      controller = P.StreamController_StreamController(null, null, null, null, false, null);
      J.transaction$3$x($.WebSqlStore__db, new Z.WebSqlStore__keys_closure(sql, controller), new Z.WebSqlStore__keys_closure0(controller), new Z.WebSqlStore__keys_closure1(controller));
      return H.setRuntimeTypeInfo(new P._ControllerStream(controller), [null]);
    },
    _save$2: function(obj, key) {
      var completer, val, upsertSql;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      val = C.JSArray_methods.toList$0([key, C.JsonCodec_null_null.encode$1(obj)]);
      if (this._idxPaths.length !== 0)
        if (!!J.getInterceptor(obj).$isMap)
          H.IterableMixinWorkaround_forEach(this._idxPaths, new Z.WebSqlStore__save_closure(val, obj));
        else
          P.print("ERROR: saving strings not supported when indexes defined.");
      upsertSql = "INSERT OR REPLACE INTO " + H.S(this.storeName) + " (" + this._updateCols + ") VALUES (" + this._updateQ + ")";
      J.transaction$2$x($.WebSqlStore__db, new Z.WebSqlStore__save_closure0(key, completer, val, upsertSql), new Z.WebSqlStore__save_closure1(completer));
      return completer.future;
    },
    _getByKey$1: function(key) {
      var completer, sql;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      sql = "SELECT value FROM " + H.S(this.storeName) + " WHERE id = ?";
      J.readTransaction$2$x($.WebSqlStore__db, new Z.WebSqlStore__getByKey_closure(key, completer, sql), new Z.WebSqlStore__getByKey_closure0(completer));
      return completer.future;
    },
    _removeByKey$1: function(key) {
      var completer, sql;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      sql = "DELETE FROM " + H.S(this.storeName) + " WHERE id = ?";
      J.transaction$2$x($.WebSqlStore__db, new Z.WebSqlStore__removeByKey_closure(key, completer, sql), new Z.WebSqlStore__removeByKey_closure0(completer));
      return completer.future;
    },
    _nuke$0: function() {
      var completer, sql;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      sql = "DELETE FROM " + H.S(this.storeName);
      J.transaction$2$x($.WebSqlStore__db, new Z.WebSqlStore__nuke_closure(completer, sql), new Z.WebSqlStore__nuke_closure0(completer));
      return completer.future;
    },
    _all$0: function() {
      var sql, controller;
      sql = "SELECT id,value FROM " + H.S(this.storeName);
      controller = P.StreamController_StreamController(null, null, null, null, false, H.getTypeArgumentByIndex(this, 0));
      J.transaction$3$x($.WebSqlStore__db, new Z.WebSqlStore__all_closure(sql, controller), new Z.WebSqlStore__all_closure0(controller), new Z.WebSqlStore__all_closure1(controller));
      return H.setRuntimeTypeInfo(new P._ControllerStream(controller), [null]);
    },
    static: {"^": "WebSqlStore_VERSION,WebSqlStore_INITIAL_SIZE,WebSqlStore__db"}
  },
  WebSqlStore__initDb_closure: {
    "^": "Closure:55;box_0,this_1",
    call$1: function(idx) {
      var t1, col, t2;
      t1 = J.getInterceptor$x(idx);
      col = t1.get$keyPath(idx);
      t2 = J.getInterceptor(col);
      if (!!t2.$isList)
        t2.forEach$1(col, new Z.WebSqlStore__initDb__closure0(this.box_0, this.this_1, idx));
      else if (typeof col === "string") {
        t2 = this.box_0;
        t2.sql_0 = t2.sql_0 + (", " + col + " " + idx.get$websqlType());
        t2 = this.this_1;
        t2._updateCols = t2._updateCols + ("," + col);
        t2._updateQ += ", ?";
        t2._idxPaths.push(col);
      } else
        P.print("Not supported INDEX in WEBSQL - " + H.S(idx));
      this.this_1._indexMap.$indexSet(0, t1.get$name(idx), idx);
    },
    $isFunction: true
  },
  WebSqlStore__initDb__closure0: {
    "^": "Closure:55;box_0,this_2,idx_3",
    call$1: function(colName) {
      var t1 = this.box_0;
      t1.sql_0 = t1.sql_0 + (", " + H.S(colName) + " " + this.idx_3.get$websqlType());
      t1 = this.this_2;
      t1._updateCols = t1._updateCols + ("," + H.S(colName));
      t1._updateQ += ", ?";
      t1._idxPaths.push(colName);
    },
    $isFunction: true
  },
  WebSqlStore__initDb_closure0: {
    "^": "Closure:55;box_0,this_4,completer_5",
    call$1: [function(txn) {
      J.executeSql$3$x(txn, this.box_0.sql_0, [], new Z.WebSqlStore__initDb__closure(this.this_4, this.completer_5));
    }, "call$1", null, 2, 0, null, 128, "call"],
    $isFunction: true
  },
  WebSqlStore__initDb__closure: {
    "^": "Closure:53;this_6,completer_7",
    call$2: [function(txn, resultSet) {
      var t1;
      this.this_6._isOpen = true;
  ...
  WebSqlStore__initDb_closure1: {
    "^": "Closure:55;completer_8",
    call$1: [function(error) {
      return this.completer_8.completeError$1(error);
    }, "call$1", null, 2, 0, null, 17, "call"],
    $isFunction: true
  },
  WebSqlStore__keys_closure: {
    "^": "Closure:55;sql_0,controller_1",
    call$1: [function(txn) {
      J.executeSql$3$x(txn, this.sql_0, [], new Z.WebSqlStore__keys__closure(this.controller_1));
    }, "call$1", null, 2, 0, null, 128, "call"],
    $isFunction: true
  },
  WebSqlStore__keys__closure: {
    "^": "Closure:53;controller_2",
    call$2: [function(txn, resultSet) {
      var t1, t2, i, t3, t4;
  ...
  WebSqlStore__save_closure: {
    "^": "Closure:2;val_0,objM_1",
    call$1: function(col) {
      C.JSArray_methods.add$1(this.val_0, this.objM_1.$index(0, col));
    },
    $isFunction: true
  },
  WebSqlStore__save_closure0: {
    "^": "Closure:55;key_2,completer_3,val_4,upsertSql_5",
    call$1: [function(txn) {
      J.executeSql$3$x(txn, this.upsertSql_5, this.val_4, new Z.WebSqlStore__save__closure(this.key_2, this.completer_3));
    }, "call$1", null, 2, 0, null, 128, "call"],
    $isFunction: true
  },
  WebSqlStore__save__closure: {
    "^": "Closure:53;key_6,completer_7",
    call$2: [function(txn, resultSet) {
      var t1 = this.completer_7.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(this.key_6);
    }, "call$2", null, 4, 0, null, 128, 129, "call"],
    $isFunction: true
  },
  WebSqlStore__save_closure1: {
    "^": "Closure:55;completer_8",
    call$1: [function(error) {
      return this.completer_8.completeError$1(error);
    }, "call$1", null, 2, 0, null, 17, "call"],
  ...
  WebSqlStore__getByKey_closure: {
    "^": "Closure:55;key_0,completer_1,sql_2",
    call$1: [function(txn) {
      J.executeSql$3$x(txn, this.sql_2, [this.key_0], new Z.WebSqlStore__getByKey__closure(this.completer_1));
    }, "call$1", null, 2, 0, null, 128, "call"],
    $isFunction: true
  },
  WebSqlStore__getByKey__closure: {
    "^": "Closure:53;completer_3",
    call$2: [function(txn, resultSet) {
      var t1, val;
      ...
      if (J.get$isEmpty$asx(t1.get$rows(resultSet))) {
        ...
        val = J.item$1$x(t1.get$rows(resultSet), 0).$index(0, "value");
        if (val != null)
          val = C.JsonCodec_null_null.decode$1(val);
        t1 = this.completer_3.future;
        if (t1._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t1._asyncComplete$1(val);
      }
    }, "call$2", null, 4, 0, null, 128, 129, "call"],
    $isFunction: true
  },
  WebSqlStore__getByKey_closure0: {
    "^": "Closure:55;completer_4",
    call$1: [function(error) {
      return this.completer_4.completeError$1(error);
    }, "call$1", null, 2, 0, null, 17, "call"],
    $isFunction: true
  },
  WebSqlStore__removeByKey_closure: {
    "^": "Closure:55;key_0,completer_1,sql_2",
    call$1: [function(txn) {
      J.executeSql$3$x(txn, this.sql_2, [this.key_0], new Z.WebSqlStore__removeByKey__closure(this.completer_1));
    }, "call$1", null, 2, 0, null, 128, "call"],
    $isFunction: true
  },
  WebSqlStore__removeByKey__closure: {
    "^": "Closure:53;completer_3",
    call$2: [function(txn, resultSet) {
  ...
  WebSqlStore__removeByKey_closure0: {
    "^": "Closure:55;completer_4",
    call$1: [function(error) {
      return this.completer_4.completeError$1(error);
    }, "call$1", null, 2, 0, null, 17, "call"],
  ...
  WebSqlStore__nuke_closure: {
    "^": "Closure:55;completer_0,sql_1",
    call$1: [function(txn) {
      J.executeSql$3$x(txn, this.sql_1, [], new Z.WebSqlStore__nuke__closure(this.completer_0));
    }, "call$1", null, 2, 0, null, 128, "call"],
    $isFunction: true
  },
  WebSqlStore__nuke__closure: {
    "^": "Closure:53;completer_2",
    call$2: [function(txn, resultSet) {
  ...
  WebSqlStore__all_closure: {
    "^": "Closure:55;sql_0,controller_1",
    call$1: [function(txn) {
      J.executeSql$3$x(txn, this.sql_0, [], new Z.WebSqlStore__all__closure(this.controller_1));
    }, "call$1", null, 2, 0, null, 128, "call"],
    $isFunction: true
  },
  WebSqlStore__all__closure: {
    "^": "Closure:53;controller_2",
    call$2: [function(txn, resultSet) {
      var t1, t2, i, val, t3, t4;
      for (t1 = J.getInterceptor$x(resultSet), t2 = this.controller_2, i = 0; i < J.get$length$asx(t1.get$rows(resultSet)); ++i) {
        val = J.item$1$x(t1.get$rows(resultSet), i).$index(0, "value");
        if (val != null)
          val = C.JsonCodec_null_null.decode$1(val);
        if (t2._state >= 4)
          H.throwExpression(t2._badEventState$0());
        ...
        if ((t3 & 1) !== 0)
          ...
          t4 = new P._DelayedData(val, null);
          t4.$builtinTypeInfo = [H.getRuntimeTypeArgument(t2, "_StreamController", 0)];
          t3.add$1(0, t4);
        }
      }
    }, "call$2", null, 4, 0, null, 128, 129, "call"],
...
["matcher.core_matchers", "package:matcher/src/core_matchers.dart", , O, {
  ...
  _IsNotNull: {
    ...
    describe$1: function(description) {
      description._out.write$1("not null");
      return description;
    }
  },
  _DeepMatcher: {
    ...
    _compareSets$5: function(expected, actual, matcher, depth, $location) {
      ...
      if (C.JSInt_methods.$gt(actual.get$length(actual), expected.get$length(expected)))
        return ["larger than expected", $location];
      else if (C.JSInt_methods.$lt(actual.get$length(actual), expected.get$length(expected)))
    ...
    _recursiveMatch$4: [function(expected, actual, $location, depth) {
      ...
      if (depth === 0 || t1 > 1)
        if (!!J.getInterceptor(expected).$isSet)
          ...
          for (t1 = J.get$iterator$ax(J.get$keys$x(expected)); t1.moveNext$0(), false;) {
            key = t1.get$current();
            if (J.containsKey$1$x(actual, key) !== true)
              return ["has different length and is missing map key '" + H.S(key) + "'", $location];
          }
          for (t1 = J.get$iterator$ax(J.get$keys$x(actual)); t1.moveNext$0();) {
            key = t1.get$current();
            J.containsKey$1$x(expected, key);
            return ["has different length and has extra map key '" + H.S(key) + "'", $location];
          }
          for (t1 = J.get$iterator$ax(J.get$keys$x(expected)), t2 = depth + 1; t1.moveNext$0(), false;) {
            key = t1.get$current();
      ...
      return ["", $location];
    }, "call$4", "get$_recursiveMatch", 8, 0, 130],
  ...
  _DeepMatcher__compareSets_closure: {
    "^": "Closure:55;matcher_0,depth_1,location_2,expectedElement_3",
  ...
  _Predicate: {
    "^": "Matcher;_core_matchers$_matcher,_description",
    _core_matchers$_matcher$1: function(arg0) {
      return this._core_matchers$_matcher.call$1(arg0);
    },
    matches$2: function(_, item, matchState) {
      return this._core_matchers$_matcher$1(item);
    },
    describe$1: function(description) {
...
["matcher.expect", "package:matcher/src/expect.dart", , Y, {
  ...
  _defaultErrorFormatter: [function(actual, matcher, reason, matchState, verbose) {
    ...
    return t1._contents;
  }, "call$5", "_defaultErrorFormatter$closure", 10, 0, 49],
  TestFailure: {
    "^": "Error;message>",
    toString$0: function(_) {
      return this.message;
...
["matcher.future_matchers", "package:matcher/src/future_matchers.dart", , Z, {
  "^": "",
  _Completes: {
    "^": "Matcher;_matcher,_future_matchers$_id",
    matches$2: function(_, item, matchState) {
      var done;
      if (!J.getInterceptor(item).$isFuture)
        return false;
      done = $.get$wrapAsync().call$2(new Z._Completes_matches_closure(), this._future_matchers$_id);
      item.then$2$onError(new Z._Completes_matches_closure0(this, done), new Z._Completes_matches_closure1(this, done));
      return true;
    },
    describe$1: function(description) {
      description._out.write$1("completes to a value that ");
      description.addDescriptionOf$1(this._matcher);
      return description;
    }
  },
  ...
  _Completes_matches_closure0: {
    "^": "Closure:55;this_1,done_2",
    call$1: [function(value) {
      this.done_2.call$1(new Z._Completes_matches__closure0(this.this_1, value));
    }, "call$1", null, 2, 0, null, 14, "call"],
    $isFunction: true
  },
  _Completes_matches__closure0: {
    "^": "Closure:10;this_3,value_4",
    call$0: [function() {
      Y.expect(this.value_4, this.this_3._matcher, null, null, false);
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  _Completes_matches_closure1: {
    "^": "Closure:53;this_5,done_6",
    call$2: [function(error, trace) {
      var t1, t2, stackTrace;
      t1 = {};
      t2 = this.this_5._future_matchers$_id;
      ...
      this.done_6.call$1(new Z._Completes_matches__closure(t1));
    }, "call$2", null, 4, 0, null, 17, 133, "call"],
    $isFunction: true
  },
...
["matcher.pretty_print", "package:matcher/src/pretty_print.dart", , S, {
  ...
  }, "call$1", "_escapeString$closure", 2, 0, 44, 50],
  _escapeChar: [function(ch) {
    ...
    if (t1.$eq(ch, "'"))
      ...
      return ch;
  }, "call$1", "_escapeChar$closure", 2, 0, 44, 51],
  prettyPrint__prettyPrint: {
    "^": "Closure:134;maxLineLength_1,maxItems_2",
    call$4: function(object, indent, seen, $top) {
      ...
      if (!!t2.$isIterable) {
        ...
        strings = J.map$1$ax(t2.get$keys(object), new S.prettyPrint__prettyPrint_closure0(object, t1)).toList$0(0);
        if (strings.length > this.maxItems_2) {
          t1 = strings.length;
          if (!!strings.fixed$length)
            H.throwExpression(P.UnsupportedError$("removeRange"));
  ...
  prettyPrint__prettyPrint_pp: {
    "^": "Closure:135;box_0,_prettyPrint_3,indent_4",
    call$1: [function(child) {
  ...
  prettyPrint__prettyPrint_closure0: {
    "^": "Closure:55;object_6,pp_7",
    call$1: [function(key) {
      var t1 = this.pp_7;
      return H.S(t1.call$1(key)) + ": " + H.S(t1.call$1(J.$index$asx(this.object_6, key)));
    }, "call$1", null, 2, 0, null, 54, "call"],
    $isFunction: true
  },
...
["unittest", "package:unittest/unittest.dart", , N, {
  ...
  _SpreadArgsHelper: {
    ...
    _max0$0: [function() {
      return this._max6$0();
    }, "call$0", "get$_max0", 0, 0, 10],
    _max1$1: [function(a0) {
      return this._max6$1(a0);
    }, function() {
      return this._max1$1(C.C__ArgPlaceHolder);
    }, "_max1$0", "call$1", "call$0", "get$_max1", 0, 2, 139, 140, 141],
    ...
    }, "_max2$0", "call$2", "call$1", "call$0", "get$_max2", 0, 4, 142, 140, 140, 141, 143],
    ...
    }, "_max3$2", "call$3", "call$1", "call$0", "call$2", "get$_max3", 0, 6, 144, 140, 140, 140, 141, 143, 145],
    ...
    }, "_max4$3", "call$4", "call$1", "call$0", "call$2", "call$3", "get$_max4", 0, 8, 146, 140, 140, 140, 140, 141, 143, 145, 147],
    ...
    }, "_max5$3", "call$5", "call$1", "call$0", "call$2", "call$4", "call$3", "get$_max5", 0, 10, 148, 140, 140, 140, 140, 140, 141, 143, 145, 147, 149],
    ...
    }, "_max6$5", "call$6", "call$0", "call$1", "call$2", "call$3", "call$4", "call$5", "get$_max6", 0, 12, 150, 140, 140, 140, 140, 140, 140, 141, 143, 145, 147, 149, 151],
  ...
  TestCase__errorHandler_closure: {
    ...
    }, "call$2", null, 4, 0, null, 1, 152, "call"],
    $isFunction: true
  },
  ...
  _runTest_closure: {
    ...
    }, "call$2", null, 4, 0, null, 17, 152, "call"],
    $isFunction: true
  },
  _runTest_closure0: {
    "^": "Closure:10;testCase_2,timeout_3",
    call$0: [function() {
...
K.UserDO.$isGeneralDO = true;
K.UserDO.$isObject = true;
K.BlobDO.$isGeneralDO = true;
K.BlobDO.$isObject = true;
K.LocalSettingsDO.$isObject = true;
...
A.InitServerStatus.$isInitServerStatus = true;
A.InitServerStatus.$isObject = true;
A.HttpResp.$isHttpResp = true;
A.HttpResp.$isObject = true;
W.HttpRequest.$isHttpRequest = true;
W.HttpRequest.$isObject = true;
W.ProgressEvent.$isObject = true;
A.OperationResponse.$isOperationResponse = true;
A.OperationResponse.$isObject = true;
K.GeneralDO.$isGeneralDO = true;
K.GeneralDO.$isObject = true;
...
A.MaskComplete.$isMaskComplete = true;
A.MaskComplete.$isObject = true;
A.MaskIcon.$isMaskIcon = true;
A.MaskIcon.$isObject = true;
A.MaskMode.$isMaskMode = true;
A.MaskMode.$isObject = true;
...
C.InitServerStatus_e401 = new A.InitServerStatus("e401");
C.InitServerStatus_err = new A.InitServerStatus("err");
C.InitServerStatus_off = new A.InitServerStatus("off");
C.InitServerStatus_ok = new A.InitServerStatus("ok");
...
$.ItinnUtilContext_i = null;
$.WebSqlStore__db = null;
...
Isolate.$lazy($, "_singleton", "ItinnDataContext__singleton", "get$ItinnDataContext__singleton", function() {
  return new K.ItinnDataContext(N.Logger_Logger("itinndata"));
});
Isolate.$lazy($, "allTableNames", "LDLocalStorage_allTableNames", "get$LDLocalStorage_allTableNames", function() {
  return [];
});
Isolate.$lazy($, "_trans", "_trans", "get$_trans", function() {
  return P.LinkedHashMap_LinkedHashMap$_literal(["en", P.LinkedHashMap_LinkedHashMap$_literal(["iu.am.password.err1", "Passwords not equal!", "iu.am.signup.progress", "Creating user and logging in...", "iu.am.signup.failed", "Unable to create user!", "iu.am.signup.done", "User created.", "iu.am.signin.progress", "Logging in...", "iu.am.signin.failed", "Unable to log in!", "iu.am.signout.q", "Sign out from app?", "iu.am.signout.q2", "Save data to server before sign out?", "iu.am.signout.progress", "Signing out...", "iu.am.signout.done", "Done.", "iu.am.signout.failed", "Signing out failed!", "iu.am.signout.failed2", "Sorry, unable to save data!", "iu.am.removeprofileuser.q", "Remove user?", "iu.am.removeprofileuser.progress", "Removing user...", "iu.am.removeprofileuser.failed", "Removing user failed!", "iu.am.removeprofileuser.done", "Done.", "iu.am.changeroles.progress", "Changing role...", "iu.am.changeroles.failed", "Changing role failed!", "iu.am.changeroles.done", "Done.", "iu.sync.recoveryok", "Check your changes, please!", "iu.sync.ok", "Done.", "iu.sync.recoveryfailed", "Error while saving!", "iu.sync.err", "Unable to synchronize!", "iu.sync.err.desc1", "<br>$conflict$ conflict$s$ (Maybe other device changes?)", "iu.sync.err.desc2", "<br>$na$ data inconsitence$s$ (Ufff, sorry ;-()", "iu.sync.err.desc3", "<br>Number of not available records: $general$ (Maybe other device deletions?)", "iu.sync.err.descGeneral", "<br>Saving record faild with error : $code$.", "iu.sync.err.recovery.q", "<br>Perform recovery (remove all local data and load from server)?", "iu.sync.recovery.progress", "Recovering data from server...", "iu.sync.recovery.done", "Recovery done.", "iu.sync.recovery.failed", "Recovery failed!"], null, null), "sk", P.LinkedHashMap_LinkedHashMap$_literal(["iu.am.password.err1", "Hesl\u00e1 sa nezhoduj\u00fa!", "iu.am.signup.progress", "U\u017e\u00edvate\u013e sa vytv\u00e1ra...", "iu.am.signup.failed", "Nepodarilo sa vytvori\u0165 u\u017e\u00edvate\u013ea!", "iu.am.signup.done", "Hotovo.", "iu.am.signin.progress", "Prihlasovanie...", "iu.am.signin.failed", "Nepodarilo sa prihl\u00e1si\u0165!", "iu.am.signout.q", "Odhl\u00e1si\u0165 z aplik\u00e1cie?", "iu.am.signout.q2", "Ulo\u017ei\u0165 d\u00e1ta na server pred odhl\u00e1sen\u00edm?", "iu.am.signout.progress", "Odhlasovanie...", "iu.am.signout.done", "Hotovo.", "iu.am.signout.failed", "Nepodarilo sa odhl\u00e1si\u0165!", "iu.am.signout.failed2", "D\u00e1ta sa nepodarilo ulo\u017ei\u0165!", "iu.am.removeprofileuser.q", "Odstr\u00e1ni\u0165 u\u017e\u00edvate\u013ea?", "iu.am.removeprofileuser.progress", "U\u017e\u00edvate\u013e sa odstra\u0148uje...", "iu.am.removeprofileuser.failed", "Nepodarilo sa odstr\u00e1ni\u0165 u\u017e\u00edvate\u013ea!", "iu.am.removeprofileuser.done", "Hotovo.", "iu.am.changeroles.progress", "Rola sa men\u00ed...", "iu.am.changeroles.failed", "Nepodarilo sa zmeni\u0165 rolu!", "iu.am.changeroles.done", "Hotovo.", "iu.sync.recoveryok", "Vyskytli sa probl\u00e9mu pri synchroniz\u00e1cii d\u00e1t, syst\u00e9m sa ich pok\u00fasil vyrie\u0161i\u0165, av\u0161ak pre istotu skontrolujte va\u0161e posledn\u00e9 zmeny.", "iu.sync.ok", "Hotovo.", "iu.sync.recoveryfailed", "Vyskytli sa probl\u00e9mu pri synchroniz\u00e1cii d\u00e1t!", "iu.sync.err", "Nepodarilo sa zosynchronizova\u0165 d\u00e1ta.", "iu.sync.err.desc1", "<br>$conflict$ konfikt$s$ (Paraleln\u00e9 zmeny na inom zariaden\u00ed?)", "iu.sync.err.desc2", "<br>Po\u010det d\u00e1tov\u00fdch nekonzistenci\u00ed: $na$ (Ufff, sorry ;-()", "iu.sync.err.desc3", "<br>Po\u010det neexistuj\u00facich z\u00e1znamov: $general$ (Paraleln\u00e9 zmazanie na inom zariaden\u00ed?)", "iu.sync.err.descGeneral", "<br>Pri ulo\u017een\u00ed z\u00e1znamu sa vyskytla chyba: $code$.", "iu.sync.err.recovery.q", "<br>Vykona\u0165 obnovu d\u00e1t (odstr\u00e1ni\u0165 v\u0161etky lok\u00e1lne d\u00e1ta a nahra\u0165 znovu zo servera)?", "iu.sync.recovery.progress", "Obnovovanie d\u00e1t zo servera...", "iu.sync.recovery.done", "Obnova ukon\u010den\u00e1.", "iu.sync.recovery.failed", "Obnova zlyhala!"], null, null)], null, null);
});
Isolate.$lazy($, "INFO", "MaskIcon_INFO", "get$MaskIcon_INFO", function() {
  return new A.MaskIcon("icon-info", "");
});
Isolate.$lazy($, "ERROR", "MaskIcon_ERROR", "get$MaskIcon_ERROR", function() {
  return new A.MaskIcon("icon-error", "pulse");
});
Isolate.$lazy($, "OK", "MaskComplete_OK", "get$MaskComplete_OK", function() {
  return new A.MaskComplete("ok");
});
Isolate.$lazy($, "YES", "MaskComplete_YES", "get$MaskComplete_YES", function() {
  return new A.MaskComplete("yes");
});
Isolate.$lazy($, "UNKNOWN", "MaskComplete_UNKNOWN", "get$MaskComplete_UNKNOWN", function() {
  return new A.MaskComplete("unknown");
});
Isolate.$lazy($, "YESNO", "MaskMode_YESNO", "get$MaskMode_YESNO", function() {
  return new A.MaskMode("yesno-mode");
});
Isolate.$lazy($, "OK", "MaskMode_OK", "get$MaskMode_OK", function() {
  return new A.MaskMode("ok-mode");
});
...
"ls",
"status",
{func: "dynamic__InitServerStatus", args: [A.InitServerStatus]},
"resp",
"meDO",
P.String,
P.Object,
{func: "dynamic__HttpResp", args: [A.HttpResp]},
"req",
...
"resp3",
"resp2",
{func: "dynamic__OperationResponse", args: [A.OperationResponse]},
"items",
{func: "dynamic__dynamic_List", args: [null, [P.List, K.GeneralDO]]},
...
//# sourceMappingURL=all_tests.dart.js.map
//@ sourceMappingURL=all_tests.dart.js.map
